...
export async function detectPodmanCapabilitiesWithDependencies(dependencies = {}) {
...
export async function ensureMachineRunningWithDependencies(managed, dependencies = {}) {
    const platform = dependencies.platform ?? process.platform;
    const runPodmanCommand = dependencies.runPodmanCommand ?? runPodman;
    const detectCapabilities = dependencies.detectCapabilities ??
