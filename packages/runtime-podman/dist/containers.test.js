...
import { buildPodmanRunArgs, normalizeImage, parseHostPorts, serviceConfigHash } from "./containers.js";
...
test("buildPodmanRunArgs includes labels, env, ports, and shell command", async () => {
    ...
    const args = await buildPodmanRunArgs("app", "demo-app", service, "demo-net", "docker.io/library/node:20-alpine", "service-hash");
