...
import { detectPodmanCapabilitiesWithDependencies, ensureMachineRunningWithDependencies } from "./machine.js";
...
test("ensureMachineRunning rejects unmanaged stopped machines", async () => {
    await assert.rejects(() => ensureMachineRunningWithDependencies(false, {
        platform: "darwin",
        detectCapabilities: async () => ({
            available: true,
            rootless: true,
