...
const configSchema = z.object({
    ...
    services: z.record(z.string().regex(SAFE_IDENTIFIER_PATTERN, {
...
function interpolateConfigValue(value, env) {
    ...
    if (value && typeof value === "object") {
        return Object.fromEntries(Object.entries(value).map(([key, entry]) => [key, interpolateConfigValue(entry, env)]));
    }
    return value;
}
export async function loadLoomProject(configPath = "loom.yaml") {
...
export async function loadLoomConfig(configPath = "loom.yaml") {
