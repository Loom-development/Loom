...
<head>
    <title>Code coverage report for node_modules/.pnpm/zod@3.25.76/node_modules/zod/v3/types.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../../index.html">All files</a> / <a href="index.html">node_modules/.pnpm/zod@3.25.76/node_modules/zod/v3</a> types.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">27.21% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>1005/3693</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">52.58% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>61/116</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>43/286</span>
            </div>
...
<a name='L3694'></a><a href='#L3694'>3694</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-yes">8x</span>
<span class="cline-any cline-yes">5025x</span>
<span class="cline-any cline-yes">5025x</span>
<span class="cline-any cline-yes">5025x</span>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { ZodError, ZodIssueCode, } from "./ZodError.js";
...
class ParseInputLazyPath {
    ...
    get path() {
        if (!this._cachedPath.length) {
            if (Array.isArray(this._key)) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                this._cachedPath.push(...this._path, ...this._key);</span>
...
<span class="cstat-no" title="statement not covered" >        if (!ctx.common.issues.length) {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error("Validation failed but no issues detected.");</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return {</span>
<span class="cstat-no" title="statement not covered" >            success: false,</span>
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >            get error() {</span></span>
<span class="cstat-no" title="statement not covered" >                if (this._error)</span>
<span class="cstat-no" title="statement not covered" >                    return this._error;</span>
<span class="cstat-no" title="statement not covered" >                const error = new ZodError(ctx.common.issues);</span>
...
function processCreateParams(params) {
    ...
    if (<span class="branch-0 cbranch-no" title="branch not covered" >errorMap &amp;&amp; (invalid_type_error || required_error)) <span class="branch-0 cbranch-no" title="branch not covered" >{</span></span>
<span class="cstat-no" title="statement not covered" >        throw new Error(`Can't use "invalid_type_error" or "required_error" in conjunction with custom error map.`);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    if (errorMap)
<span class="branch-0 cbranch-no" title="branch not covered" >        return { errorMap: errorMap, description };</span>
    const customMap = <span class="fstat-no" title="function not covered" >(iss, ctx) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        const { message } = params;</span>
<span class="cstat-no" title="statement not covered" >        if (iss.code === "invalid_enum_value") {</span>
<span class="cstat-no" title="statement not covered" >            return { message: message ?? ctx.defaultError };</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        if (typeof ctx.data === "undefined") {</span>
<span class="cstat-no" title="statement not covered" >            return { message: message ?? required_error ?? ctx.defaultError };</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        if (iss.code !== "invalid_type")</span>
<span class="cstat-no" title="statement not covered" >            return { message: ctx.defaultError };</span>
<span class="cstat-no" title="statement not covered" >        return { message: message ?? invalid_type_error ?? ctx.defaultError };</span>
<span class="cstat-no" title="statement not covered" >    };</span>
    return { errorMap: customMap, description };
}
export class ZodType {
<span class="fstat-no" title="function not covered" >    get description() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.description;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    _getType(input) {
        return getParsedType(input.data);
    }
<span class="fstat-no" title="function not covered" >    _getOrReturnCtx(input, ctx) {</span>
<span class="cstat-no" title="statement not covered" >        return (ctx || {</span>
<span class="cstat-no" title="statement not covered" >            common: input.parent.common,</span>
<span class="cstat-no" title="statement not covered" >            data: input.data,</span>
<span class="cstat-no" title="statement not covered" >            parsedType: getParsedType(input.data),</span>
<span class="cstat-no" title="statement not covered" >            schemaErrorMap: this._def.errorMap,</span>
<span class="cstat-no" title="statement not covered" >            path: input.path,</span>
<span class="cstat-no" title="statement not covered" >            parent: input.parent,</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    ...
    _parseSync(input) {
        ...
        if (isAsync(result)) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            throw new Error("Synchronous parse encountered promise.");</span>
<span class="cstat-no" title="statement not covered" >        }</span>
        return result;
    }
<span class="fstat-no" title="function not covered" >    _parseAsync(input) {</span>
<span class="cstat-no" title="statement not covered" >        const result = this._parse(input);</span>
<span class="cstat-no" title="statement not covered" >        return Promise.resolve(result);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    parse(data, params) {
        const result = this.safeParse(data, params);
        if (result.success)
            return result.<span class="branch-0 cbranch-no" title="branch not covered" >data;</span>
<span class="cstat-no" title="statement not covered" >        throw result.error;</span>
    ...
    safeParse(data, params) {
        const ctx = {
            common: {
                issues: [],
                async: <span class="branch-0 cbranch-no" title="branch not covered" >params?.async ?? f</span>alse,
                contextualErrorMap: <span class="branch-0 cbranch-no" title="branch not covered" >params?.errorMap,</span>
            },
            path: <span class="branch-0 cbranch-no" title="branch not covered" >params?.path || [</span>],
            schemaErrorMap: this._def.errorMap,
            parent: null,
            data,
...
<span class="fstat-no" title="function not covered" >    "~validate"(data) {</span>
...
<span class="cstat-no" title="statement not covered" >                issues: [],</span>
<span class="cstat-no" title="statement not covered" >                async: !!this["~standard"].async,</span>
<span class="cstat-no" title="statement not covered" >            },</span>
...
<span class="cstat-no" title="statement not covered" >            parsedType: getParsedType(data),</span>
<span class="cstat-no" title="statement not covered" >        };</span>
<span class="cstat-no" title="statement not covered" >        if (!this["~standard"].async) {</span>
<span class="cstat-no" title="statement not covered" >            try {</span>
<span class="cstat-no" title="statement not covered" >                const result = this._parseSync({ data, path: [], parent: ctx });</span>
<span class="cstat-no" title="statement not covered" >                return isValid(result)</span>
<span class="cstat-no" title="statement not covered" >                    ? {</span>
<span class="cstat-no" title="statement not covered" >                        value: result.value,</span>
<span class="cstat-no" title="statement not covered" >                    }</span>
<span class="cstat-no" title="statement not covered" >                    : {</span>
<span class="cstat-no" title="statement not covered" >                        issues: ctx.common.issues,</span>
<span class="cstat-no" title="statement not covered" >                    };</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            catch (err) {</span>
<span class="cstat-no" title="statement not covered" >                if (err?.message?.toLowerCase()?.includes("encountered")) {</span>
<span class="cstat-no" title="statement not covered" >                    this["~standard"].async = true;</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                ctx.common = {</span>
<span class="cstat-no" title="statement not covered" >                    issues: [],</span>
<span class="cstat-no" title="statement not covered" >                    async: true,</span>
<span class="cstat-no" title="statement not covered" >                };</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return this._parseAsync({ data, path: [], parent: ctx }).then((result) =&gt; isValid(result)</span>
<span class="cstat-no" title="statement not covered" >            ? {</span>
<span class="cstat-no" title="statement not covered" >                value: result.value,</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            : {</span>
...
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    async parseAsync(data, params) {</span>
<span class="cstat-no" title="statement not covered" >        const result = await this.safeParseAsync(data, params);</span>
...
<span class="cstat-no" title="statement not covered" >        throw result.error;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    async safeParseAsync(data, params) {</span>
<span class="cstat-no" title="statement not covered" >        const ctx = {</span>
<span class="cstat-no" title="statement not covered" >            common: {</span>
<span class="cstat-no" title="statement not covered" >                issues: [],</span>
<span class="cstat-no" title="statement not covered" >                contextualErrorMap: params?.errorMap,</span>
<span class="cstat-no" title="statement not covered" >                async: true,</span>
<span class="cstat-no" title="statement not covered" >            },</span>
<span class="cstat-no" title="statement not covered" >            path: params?.path || [],</span>
<span class="cstat-no" title="statement not covered" >            schemaErrorMap: this._def.errorMap,</span>
<span class="cstat-no" title="statement not covered" >            parent: null,</span>
<span class="cstat-no" title="statement not covered" >            data,</span>
<span class="cstat-no" title="statement not covered" >            parsedType: getParsedType(data),</span>
<span class="cstat-no" title="statement not covered" >        };</span>
<span class="cstat-no" title="statement not covered" >        const maybeAsyncResult = this._parse({ data, path: ctx.path, parent: ctx });</span>
<span class="cstat-no" title="statement not covered" >        const result = await (isAsync(maybeAsyncResult) ? maybeAsyncResult : Promise.resolve(maybeAsyncResult));</span>
<span class="cstat-no" title="statement not covered" >        return handleResult(ctx, result);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    refine(check, message) {</span>
<span class="cstat-no" title="statement not covered" >        const getIssueProperties = (val) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            if (typeof message === "string" || typeof message === "undefined") {</span>
<span class="cstat-no" title="statement not covered" >                return { message };</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (typeof message === "function") {</span>
<span class="cstat-no" title="statement not covered" >                return message(val);</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else {</span>
<span class="cstat-no" title="statement not covered" >                return message;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        };</span>
<span class="cstat-no" title="statement not covered" >        return this._refinement((val, ctx) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            const result = check(val);</span>
<span class="cstat-no" title="statement not covered" >            const setError = () =&gt; ctx.addIssue({</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.custom,</span>
<span class="cstat-no" title="statement not covered" >                ...getIssueProperties(val),</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            if (typeof Promise !== "undefined" &amp;&amp; result instanceof Promise) {</span>
<span class="cstat-no" title="statement not covered" >                return result.then((data) =&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    refinement(check, refinementData) {</span>
<span class="cstat-no" title="statement not covered" >        return this._refinement((val, ctx) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            if (!check(val)) {</span>
<span class="cstat-no" title="statement not covered" >                ctx.addIssue(typeof refinementData === "function" ? refinementData(val, ctx) : refinementData);</span>
<span class="cstat-no" title="statement not covered" >                return false;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else {</span>
<span class="cstat-no" title="statement not covered" >                return true;</span>
...
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    _refinement(refinement) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodEffects({</span>
<span class="cstat-no" title="statement not covered" >            schema: this,</span>
<span class="cstat-no" title="statement not covered" >            typeName: ZodFirstPartyTypeKind.ZodEffects,</span>
<span class="cstat-no" title="statement not covered" >            effect: { type: "refinement", refinement },</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    superRefine(refinement) {</span>
<span class="cstat-no" title="statement not covered" >        return this._refinement(refinement);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    constructor(def) {
        ...
        this["~standard"] = {
            version: 1,
            vendor: "zod",
            validate: <span class="fstat-no" title="function not covered" >(data) =&gt; this["~validate"](data),</span>
        };
    }
    optional() {
        return ZodOptional.create(this, this._def);
    }
<span class="fstat-no" title="function not covered" >    nullable() {</span>
<span class="cstat-no" title="statement not covered" >        return ZodNullable.create(this, this._def);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    nullish() {</span>
<span class="cstat-no" title="statement not covered" >        return this.nullable().optional();</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    array() {</span>
<span class="cstat-no" title="statement not covered" >        return ZodArray.create(this);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    promise() {</span>
<span class="cstat-no" title="statement not covered" >        return ZodPromise.create(this, this._def);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    or(option) {</span>
<span class="cstat-no" title="statement not covered" >        return ZodUnion.create([this, option], this._def);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    and(incoming) {</span>
<span class="cstat-no" title="statement not covered" >        return ZodIntersection.create(this, incoming, this._def);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    transform(transform) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodEffects({</span>
<span class="cstat-no" title="statement not covered" >            ...processCreateParams(this._def),</span>
<span class="cstat-no" title="statement not covered" >            schema: this,</span>
<span class="cstat-no" title="statement not covered" >            typeName: ZodFirstPartyTypeKind.ZodEffects,</span>
<span class="cstat-no" title="statement not covered" >            effect: { type: "transform", transform },</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    default(def) {
        const defaultValueFunc = typeof def === <span class="branch-0 cbranch-no" title="branch not covered" >"function" ? def : <span class="fstat-no" title="function not covered" >(</span>) =&gt; def;</span>
...
<span class="fstat-no" title="function not covered" >    brand() {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodBranded({</span>
<span class="cstat-no" title="statement not covered" >            typeName: ZodFirstPartyTypeKind.ZodBranded,</span>
<span class="cstat-no" title="statement not covered" >            type: this,</span>
<span class="cstat-no" title="statement not covered" >            ...processCreateParams(this._def),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    catch(def) {</span>
<span class="cstat-no" title="statement not covered" >        const catchValueFunc = typeof def === "function" ? def : () =&gt; def;</span>
<span class="cstat-no" title="statement not covered" >        return new ZodCatch({</span>
<span class="cstat-no" title="statement not covered" >            ...processCreateParams(this._def),</span>
<span class="cstat-no" title="statement not covered" >            innerType: this,</span>
<span class="cstat-no" title="statement not covered" >            catchValue: catchValueFunc,</span>
<span class="cstat-no" title="statement not covered" >            typeName: ZodFirstPartyTypeKind.ZodCatch,</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    describe(description) {</span>
<span class="cstat-no" title="statement not covered" >        const This = this.constructor;</span>
<span class="cstat-no" title="statement not covered" >        return new This({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            description,</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    pipe(target) {</span>
<span class="cstat-no" title="statement not covered" >        return ZodPipeline.create(this, target);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    readonly() {</span>
<span class="cstat-no" title="statement not covered" >        return ZodReadonly.create(this);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    isOptional() {</span>
<span class="cstat-no" title="statement not covered" >        return this.safeParse(undefined).success;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    isNullable() {</span>
<span class="cstat-no" title="statement not covered" >        return this.safeParse(null).success;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
...
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function timeRegexSource(args) {</span></span>
<span class="cstat-no" title="statement not covered" >    let secondsRegexSource = `[0-5]\\d`;</span>
<span class="cstat-no" title="statement not covered" >    if (args.precision) {</span>
<span class="cstat-no" title="statement not covered" >        secondsRegexSource = `${secondsRegexSource}\\.\\d{${args.precision}}`;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (args.precision == null) {</span>
<span class="cstat-no" title="statement not covered" >        secondsRegexSource = `${secondsRegexSource}(\\.\\d+)?`;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    const secondsQuantifier = args.precision ? "+" : "?"; // require seconds if precision is nonzero</span>
<span class="cstat-no" title="statement not covered" >    return `([01]\\d|2[0-3]):[0-5]\\d(:${secondsRegexSource})${secondsQuantifier}`;</span>
<span class="cstat-no" title="statement not covered" >}</span>
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function timeRegex(args) {</span></span>
<span class="cstat-no" title="statement not covered" >    return new RegExp(`^${timeRegexSource(args)}$`);</span>
<span class="cstat-no" title="statement not covered" >}</span>
// Adapted from https://stackoverflow.com/a/3143231
export <span class="fstat-no" title="function not covered" >function datetimeRegex(args) {</span>
<span class="cstat-no" title="statement not covered" >    let regex = `${dateRegexSource}T${timeRegexSource(args)}`;</span>
<span class="cstat-no" title="statement not covered" >    const opts = [];</span>
<span class="cstat-no" title="statement not covered" >    opts.push(args.local ? `Z?` : `Z`);</span>
<span class="cstat-no" title="statement not covered" >    if (args.offset)</span>
<span class="cstat-no" title="statement not covered" >        opts.push(`([+-]\\d{2}:?\\d{2})`);</span>
<span class="cstat-no" title="statement not covered" >    regex = `${regex}(${opts.join("|")})`;</span>
<span class="cstat-no" title="statement not covered" >    return new RegExp(`^${regex}$`);</span>
<span class="cstat-no" title="statement not covered" >}</span>
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function isValidIP(ip, version) {</span></span>
<span class="cstat-no" title="statement not covered" >    if ((version === "v4" || !version) &amp;&amp; ipv4Regex.test(ip)) {</span>
<span class="cstat-no" title="statement not covered" >        return true;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    if ((version === "v6" || !version) &amp;&amp; ipv6Regex.test(ip)) {</span>
<span class="cstat-no" title="statement not covered" >        return true;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    return false;</span>
<span class="cstat-no" title="statement not covered" >}</span>
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function isValidJWT(jwt, alg) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (!jwtRegex.test(jwt))</span>
<span class="cstat-no" title="statement not covered" >        return false;</span>
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >        const [header] = jwt.split(".");</span>
<span class="cstat-no" title="statement not covered" >        if (!header)</span>
<span class="cstat-no" title="statement not covered" >            return false;</span>
<span class="cstat-no" title="statement not covered" >        // Convert base64url to base64</span>
<span class="cstat-no" title="statement not covered" >        const base64 = header</span>
<span class="cstat-no" title="statement not covered" >            .replace(/-/g, "+")</span>
<span class="cstat-no" title="statement not covered" >            .replace(/_/g, "/")</span>
<span class="cstat-no" title="statement not covered" >            .padEnd(header.length + ((4 - (header.length % 4)) % 4), "=");</span>
<span class="cstat-no" title="statement not covered" >        const decoded = JSON.parse(atob(base64));</span>
<span class="cstat-no" title="statement not covered" >        if (typeof decoded !== "object" || decoded === null)</span>
<span class="cstat-no" title="statement not covered" >            return false;</span>
<span class="cstat-no" title="statement not covered" >        if ("typ" in decoded &amp;&amp; decoded?.typ !== "JWT")</span>
<span class="cstat-no" title="statement not covered" >            return false;</span>
<span class="cstat-no" title="statement not covered" >        if (!decoded.alg)</span>
<span class="cstat-no" title="statement not covered" >            return false;</span>
<span class="cstat-no" title="statement not covered" >        if (alg &amp;&amp; decoded.alg !== alg)</span>
<span class="cstat-no" title="statement not covered" >            return false;</span>
<span class="cstat-no" title="statement not covered" >        return true;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
...
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >}</span>
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function isValidCidr(ip, version) {</span></span>
<span class="cstat-no" title="statement not covered" >    if ((version === "v4" || !version) &amp;&amp; ipv4CidrRegex.test(ip)) {</span>
<span class="cstat-no" title="statement not covered" >        return true;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    if ((version === "v6" || !version) &amp;&amp; ipv6CidrRegex.test(ip)) {</span>
<span class="cstat-no" title="statement not covered" >        return true;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    return false;</span>
<span class="cstat-no" title="statement not covered" >}</span>
export class ZodString extends ZodType {
    _parse(input) {
        if (this._def.coerce) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            input.data = String(input.data);</span>
<span class="cstat-no" title="statement not covered" >        }</span>
        const parsedType = this._getType(input);
        if (parsedType !== ZodParsedType.string) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            const ctx = this._getOrReturnCtx(input);</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                expected: ZodParsedType.string,</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
...
<span class="cstat-no" title="statement not covered" >        }</span>
        ...
        for (const check of this._def.checks) {
            if (check.kind === "min") {
                if (input.data.length &lt; check.value) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.too_small,</span>
<span class="cstat-no" title="statement not covered" >                        minimum: check.value,</span>
<span class="cstat-no" title="statement not covered" >                        type: "string",</span>
<span class="cstat-no" title="statement not covered" >                        inclusive: true,</span>
<span class="cstat-no" title="statement not covered" >                        exact: false,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
            }
            else if (check.kind === "max") <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                if (input.data.length &gt; check.value) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.too_big,</span>
<span class="cstat-no" title="statement not covered" >                        maximum: check.value,</span>
<span class="cstat-no" title="statement not covered" >                        type: "string",</span>
<span class="cstat-no" title="statement not covered" >                        inclusive: true,</span>
<span class="cstat-no" title="statement not covered" >                        exact: false,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
...
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
            else if (check.kind === "length") <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                const tooBig = input.data.length &gt; check.value;</span>
<span class="cstat-no" title="statement not covered" >                const tooSmall = input.data.length &lt; check.value;</span>
<span class="cstat-no" title="statement not covered" >                if (tooBig || tooSmall) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    if (tooBig) {</span>
<span class="cstat-no" title="statement not covered" >                        addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                            code: ZodIssueCode.too_big,</span>
<span class="cstat-no" title="statement not covered" >                            maximum: check.value,</span>
<span class="cstat-no" title="statement not covered" >                            type: "string",</span>
<span class="cstat-no" title="statement not covered" >                            inclusive: true,</span>
<span class="cstat-no" title="statement not covered" >                            exact: true,</span>
<span class="cstat-no" title="statement not covered" >                            message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                        });</span>
<span class="cstat-no" title="statement not covered" >                    }</span>
<span class="cstat-no" title="statement not covered" >                    else if (tooSmall) {</span>
<span class="cstat-no" title="statement not covered" >                        addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                            code: ZodIssueCode.too_small,</span>
<span class="cstat-no" title="statement not covered" >                            minimum: check.value,</span>
<span class="cstat-no" title="statement not covered" >                            type: "string",</span>
...
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
            else if (check.kind === "email") <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                if (!emailRegex.test(input.data)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        validation: "email",</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
            else if (check.kind === "emoji") <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                if (!emojiRegex) {</span>
<span class="cstat-no" title="statement not covered" >                    emojiRegex = new RegExp(_emojiRegex, "u");</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                if (!emojiRegex.test(input.data)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        validation: "emoji",</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
            else if (check.kind === "uuid") <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                if (!uuidRegex.test(input.data)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        validation: "uuid",</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
            else if (check.kind === "nanoid") <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                if (!nanoidRegex.test(input.data)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        validation: "nanoid",</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
            else if (check.kind === "cuid") <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                if (!cuidRegex.test(input.data)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        validation: "cuid",</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
            else if (check.kind === "cuid2") <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                if (!cuid2Regex.test(input.data)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        validation: "cuid2",</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
            else if (check.kind === "ulid") <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                if (!ulidRegex.test(input.data)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        validation: "ulid",</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
            else if (check.kind === "url") <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                try {</span>
<span class="cstat-no" title="statement not covered" >                    new URL(input.data);</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                catch {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        validation: "url",</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
...
<span class="cstat-no" title="statement not covered" >            }</span>
                ...
                if (!testResult) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        validation: "regex",</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="branch-0 cbranch-no" title="branch not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "trim") {</span>
<span class="cstat-no" title="statement not covered" >                input.data = input.data.trim();</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "includes") {</span>
<span class="cstat-no" title="statement not covered" >                if (!input.data.includes(check.value, check.position)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        validation: { includes: check.value, position: check.position },</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "toLowerCase") {</span>
<span class="cstat-no" title="statement not covered" >                input.data = input.data.toLowerCase();</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "toUpperCase") {</span>
<span class="cstat-no" title="statement not covered" >                input.data = input.data.toUpperCase();</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "startsWith") {</span>
<span class="cstat-no" title="statement not covered" >                if (!input.data.startsWith(check.value)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        validation: { startsWith: check.value },</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "endsWith") {</span>
<span class="cstat-no" title="statement not covered" >                if (!input.data.endsWith(check.value)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        validation: { endsWith: check.value },</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "datetime") {</span>
<span class="cstat-no" title="statement not covered" >                const regex = datetimeRegex(check);</span>
<span class="cstat-no" title="statement not covered" >                if (!regex.test(input.data)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        validation: "datetime",</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "date") {</span>
<span class="cstat-no" title="statement not covered" >                const regex = dateRegex;</span>
<span class="cstat-no" title="statement not covered" >                if (!regex.test(input.data)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        validation: "date",</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "time") {</span>
<span class="cstat-no" title="statement not covered" >                const regex = timeRegex(check);</span>
<span class="cstat-no" title="statement not covered" >                if (!regex.test(input.data)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        validation: "time",</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "duration") {</span>
<span class="cstat-no" title="statement not covered" >                if (!durationRegex.test(input.data)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        validation: "duration",</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "ip") {</span>
<span class="cstat-no" title="statement not covered" >                if (!isValidIP(input.data, check.version)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        validation: "ip",</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "jwt") {</span>
<span class="cstat-no" title="statement not covered" >                if (!isValidJWT(input.data, check.alg)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        validation: "jwt",</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "cidr") {</span>
<span class="cstat-no" title="statement not covered" >                if (!isValidCidr(input.data, check.version)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        validation: "cidr",</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "base64") {</span>
<span class="cstat-no" title="statement not covered" >                if (!base64Regex.test(input.data)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        validation: "base64",</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "base64url") {</span>
<span class="cstat-no" title="statement not covered" >                if (!base64urlRegex.test(input.data)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        validation: "base64url",</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
...
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else {</span>
<span class="cstat-no" title="statement not covered" >                util.assertNever(check);</span>
<span class="cstat-no" title="statement not covered" >            }</span>
        }
        return { status: status.value, value: input.data };
    }
<span class="fstat-no" title="function not covered" >    _regex(regex, validation, message) {</span>
<span class="cstat-no" title="statement not covered" >        return this.refinement((data) =&gt; regex.test(data), {</span>
<span class="cstat-no" title="statement not covered" >            validation,</span>
<span class="cstat-no" title="statement not covered" >            code: ZodIssueCode.invalid_string,</span>
<span class="cstat-no" title="statement not covered" >            ...errorUtil.errToObj(message),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    _addCheck(check) {
...
<span class="fstat-no" title="function not covered" >    email(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({ kind: "email", ...errorUtil.errToObj(message) });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    url(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({ kind: "url", ...errorUtil.errToObj(message) });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    emoji(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({ kind: "emoji", ...errorUtil.errToObj(message) });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    uuid(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({ kind: "uuid", ...errorUtil.errToObj(message) });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    nanoid(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({ kind: "nanoid", ...errorUtil.errToObj(message) });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    cuid(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({ kind: "cuid", ...errorUtil.errToObj(message) });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    cuid2(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({ kind: "cuid2", ...errorUtil.errToObj(message) });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    ulid(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({ kind: "ulid", ...errorUtil.errToObj(message) });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    base64(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({ kind: "base64", ...errorUtil.errToObj(message) });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    base64url(message) {</span>
<span class="cstat-no" title="statement not covered" >        // base64url encoding is a modification of base64 that can safely be used in URLs and filenames</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({</span>
<span class="cstat-no" title="statement not covered" >            kind: "base64url",</span>
<span class="cstat-no" title="statement not covered" >            ...errorUtil.errToObj(message),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    jwt(options) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({ kind: "jwt", ...errorUtil.errToObj(options) });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    ip(options) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({ kind: "ip", ...errorUtil.errToObj(options) });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    cidr(options) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({ kind: "cidr", ...errorUtil.errToObj(options) });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    datetime(options) {</span>
<span class="cstat-no" title="statement not covered" >        if (typeof options === "string") {</span>
<span class="cstat-no" title="statement not covered" >            return this._addCheck({</span>
<span class="cstat-no" title="statement not covered" >                kind: "datetime",</span>
<span class="cstat-no" title="statement not covered" >                precision: null,</span>
<span class="cstat-no" title="statement not covered" >                offset: false,</span>
<span class="cstat-no" title="statement not covered" >                local: false,</span>
<span class="cstat-no" title="statement not covered" >                message: options,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({</span>
<span class="cstat-no" title="statement not covered" >            kind: "datetime",</span>
<span class="cstat-no" title="statement not covered" >            precision: typeof options?.precision === "undefined" ? null : options?.precision,</span>
<span class="cstat-no" title="statement not covered" >            offset: options?.offset ?? false,</span>
<span class="cstat-no" title="statement not covered" >            local: options?.local ?? false,</span>
<span class="cstat-no" title="statement not covered" >            ...errorUtil.errToObj(options?.message),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    date(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({ kind: "date", message });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    time(options) {</span>
<span class="cstat-no" title="statement not covered" >        if (typeof options === "string") {</span>
<span class="cstat-no" title="statement not covered" >            return this._addCheck({</span>
<span class="cstat-no" title="statement not covered" >                kind: "time",</span>
<span class="cstat-no" title="statement not covered" >                precision: null,</span>
<span class="cstat-no" title="statement not covered" >                message: options,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >        }</span>
...
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    duration(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({ kind: "duration", ...errorUtil.errToObj(message) });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    regex(regex, message) {
...
<span class="fstat-no" title="function not covered" >    includes(value, options) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({</span>
<span class="cstat-no" title="statement not covered" >            kind: "includes",</span>
<span class="cstat-no" title="statement not covered" >            value: value,</span>
<span class="cstat-no" title="statement not covered" >            position: options?.position,</span>
<span class="cstat-no" title="statement not covered" >            ...errorUtil.errToObj(options?.message),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    startsWith(value, message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({</span>
<span class="cstat-no" title="statement not covered" >            kind: "startsWith",</span>
<span class="cstat-no" title="statement not covered" >            value: value,</span>
<span class="cstat-no" title="statement not covered" >            ...errorUtil.errToObj(message),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    endsWith(value, message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({</span>
<span class="cstat-no" title="statement not covered" >            kind: "endsWith",</span>
<span class="cstat-no" title="statement not covered" >            value: value,</span>
<span class="cstat-no" title="statement not covered" >            ...errorUtil.errToObj(message),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
...
<span class="fstat-no" title="function not covered" >    max(maxLength, message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({</span>
<span class="cstat-no" title="statement not covered" >            kind: "max",</span>
<span class="cstat-no" title="statement not covered" >            value: maxLength,</span>
<span class="cstat-no" title="statement not covered" >            ...errorUtil.errToObj(message),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    length(len, message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({</span>
<span class="cstat-no" title="statement not covered" >            kind: "length",</span>
<span class="cstat-no" title="statement not covered" >            value: len,</span>
<span class="cstat-no" title="statement not covered" >            ...errorUtil.errToObj(message),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    /**
     * Equivalent to `.min(1)`
     */
<span class="fstat-no" title="function not covered" >    nonempty(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this.min(1, errorUtil.errToObj(message));</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    trim() {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodString({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            checks: [...this._def.checks, { kind: "trim" }],</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    toLowerCase() {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodString({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            checks: [...this._def.checks, { kind: "toLowerCase" }],</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    toUpperCase() {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodString({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            checks: [...this._def.checks, { kind: "toUpperCase" }],</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get isDatetime() {</span>
<span class="cstat-no" title="statement not covered" >        return !!this._def.checks.find((ch) =&gt; ch.kind === "datetime");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get isDate() {</span>
<span class="cstat-no" title="statement not covered" >        return !!this._def.checks.find((ch) =&gt; ch.kind === "date");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get isTime() {</span>
<span class="cstat-no" title="statement not covered" >        return !!this._def.checks.find((ch) =&gt; ch.kind === "time");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get isDuration() {</span>
<span class="cstat-no" title="statement not covered" >        return !!this._def.checks.find((ch) =&gt; ch.kind === "duration");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get isEmail() {</span>
<span class="cstat-no" title="statement not covered" >        return !!this._def.checks.find((ch) =&gt; ch.kind === "email");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get isURL() {</span>
<span class="cstat-no" title="statement not covered" >        return !!this._def.checks.find((ch) =&gt; ch.kind === "url");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get isEmoji() {</span>
<span class="cstat-no" title="statement not covered" >        return !!this._def.checks.find((ch) =&gt; ch.kind === "emoji");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get isUUID() {</span>
<span class="cstat-no" title="statement not covered" >        return !!this._def.checks.find((ch) =&gt; ch.kind === "uuid");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get isNANOID() {</span>
<span class="cstat-no" title="statement not covered" >        return !!this._def.checks.find((ch) =&gt; ch.kind === "nanoid");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get isCUID() {</span>
<span class="cstat-no" title="statement not covered" >        return !!this._def.checks.find((ch) =&gt; ch.kind === "cuid");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get isCUID2() {</span>
<span class="cstat-no" title="statement not covered" >        return !!this._def.checks.find((ch) =&gt; ch.kind === "cuid2");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get isULID() {</span>
<span class="cstat-no" title="statement not covered" >        return !!this._def.checks.find((ch) =&gt; ch.kind === "ulid");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get isIP() {</span>
<span class="cstat-no" title="statement not covered" >        return !!this._def.checks.find((ch) =&gt; ch.kind === "ip");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get isCIDR() {</span>
<span class="cstat-no" title="statement not covered" >        return !!this._def.checks.find((ch) =&gt; ch.kind === "cidr");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get isBase64() {</span>
<span class="cstat-no" title="statement not covered" >        return !!this._def.checks.find((ch) =&gt; ch.kind === "base64");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get isBase64url() {</span>
<span class="cstat-no" title="statement not covered" >        // base64url encoding is a modification of base64 that can safely be used in URLs and filenames</span>
<span class="cstat-no" title="statement not covered" >        return !!this._def.checks.find((ch) =&gt; ch.kind === "base64url");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get minLength() {</span>
<span class="cstat-no" title="statement not covered" >        let min = null;</span>
<span class="cstat-no" title="statement not covered" >        for (const ch of this._def.checks) {</span>
<span class="cstat-no" title="statement not covered" >            if (ch.kind === "min") {</span>
<span class="cstat-no" title="statement not covered" >                if (min === null || ch.value &gt; min)</span>
<span class="cstat-no" title="statement not covered" >                    min = ch.value;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return min;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get maxLength() {</span>
<span class="cstat-no" title="statement not covered" >        let max = null;</span>
<span class="cstat-no" title="statement not covered" >        for (const ch of this._def.checks) {</span>
<span class="cstat-no" title="statement not covered" >            if (ch.kind === "max") {</span>
<span class="cstat-no" title="statement not covered" >                if (max === null || ch.value &lt; max)</span>
<span class="cstat-no" title="statement not covered" >                    max = ch.value;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
...
ZodString.create = (params) =&gt; {
    return new ZodString({
        ...
        coerce: <span class="branch-0 cbranch-no" title="branch not covered" >params?.coerce ?? f</span>alse,
        ...processCreateParams(params),
    });
};
// https://stackoverflow.com/questions/3966484/why-does-modulus-operator-return-fractional-number-in-javascript/31711034#31711034
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function floatSafeRemainder(val, step) {</span></span>
<span class="cstat-no" title="statement not covered" >    const valDecCount = (val.toString().split(".")[1] || "").length;</span>
<span class="cstat-no" title="statement not covered" >    const stepDecCount = (step.toString().split(".")[1] || "").length;</span>
<span class="cstat-no" title="statement not covered" >    const decCount = valDecCount &gt; stepDecCount ? valDecCount : stepDecCount;</span>
<span class="cstat-no" title="statement not covered" >    const valInt = Number.parseInt(val.toFixed(decCount).replace(".", ""));</span>
<span class="cstat-no" title="statement not covered" >    const stepInt = Number.parseInt(step.toFixed(decCount).replace(".", ""));</span>
<span class="cstat-no" title="statement not covered" >    return (valInt % stepInt) / 10 ** decCount;</span>
<span class="cstat-no" title="statement not covered" >}</span>
export class ZodNumber extends ZodType {
    ...
    _parse(input) {
        if (this._def.coerce) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            input.data = Number(input.data);</span>
<span class="cstat-no" title="statement not covered" >        }</span>
        const parsedType = this._getType(input);
        if (parsedType !== ZodParsedType.number) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            const ctx = this._getOrReturnCtx(input);</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                expected: ZodParsedType.number,</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
        ...
        for (const check of this._def.checks) {
            if (check.kind === "int") {
                if (!util.isInteger(input.data)) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                        expected: "integer",</span>
<span class="cstat-no" title="statement not covered" >                        received: "float",</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
                ...
                if (tooSmall) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.too_small,</span>
<span class="cstat-no" title="statement not covered" >                        minimum: check.value,</span>
<span class="cstat-no" title="statement not covered" >                        type: "number",</span>
<span class="cstat-no" title="statement not covered" >                        inclusive: check.inclusive,</span>
<span class="cstat-no" title="statement not covered" >                        exact: false,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="branch-0 cbranch-no" title="branch not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "max") {</span>
<span class="cstat-no" title="statement not covered" >                const tooBig = check.inclusive ? input.data &gt; check.value : input.data &gt;= check.value;</span>
<span class="cstat-no" title="statement not covered" >                if (tooBig) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.too_big,</span>
...
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "multipleOf") {</span>
<span class="cstat-no" title="statement not covered" >                if (floatSafeRemainder(input.data, check.value) !== 0) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.not_multiple_of,</span>
<span class="cstat-no" title="statement not covered" >                        multipleOf: check.value,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "finite") {</span>
<span class="cstat-no" title="statement not covered" >                if (!Number.isFinite(input.data)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.not_finite,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
...
<span class="fstat-no" title="function not covered" >    gte(value, message) {</span>
<span class="cstat-no" title="statement not covered" >        return this.setLimit("min", value, true, errorUtil.toString(message));</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    gt(value, message) {</span>
<span class="cstat-no" title="statement not covered" >        return this.setLimit("min", value, false, errorUtil.toString(message));</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    lte(value, message) {</span>
<span class="cstat-no" title="statement not covered" >        return this.setLimit("max", value, true, errorUtil.toString(message));</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    lt(value, message) {</span>
<span class="cstat-no" title="statement not covered" >        return this.setLimit("max", value, false, errorUtil.toString(message));</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    setLimit(kind, value, inclusive, message) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodNumber({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            checks: [</span>
<span class="cstat-no" title="statement not covered" >                ...this._def.checks,</span>
<span class="cstat-no" title="statement not covered" >                {</span>
<span class="cstat-no" title="statement not covered" >                    kind,</span>
<span class="cstat-no" title="statement not covered" >                    value,</span>
<span class="cstat-no" title="statement not covered" >                    inclusive,</span>
<span class="cstat-no" title="statement not covered" >                    message: errorUtil.toString(message),</span>
<span class="cstat-no" title="statement not covered" >                },</span>
<span class="cstat-no" title="statement not covered" >            ],</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
...
<span class="fstat-no" title="function not covered" >    negative(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({</span>
<span class="cstat-no" title="statement not covered" >            kind: "max",</span>
<span class="cstat-no" title="statement not covered" >            value: 0,</span>
<span class="cstat-no" title="statement not covered" >            inclusive: false,</span>
<span class="cstat-no" title="statement not covered" >            message: errorUtil.toString(message),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    nonpositive(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({</span>
<span class="cstat-no" title="statement not covered" >            kind: "max",</span>
<span class="cstat-no" title="statement not covered" >            value: 0,</span>
<span class="cstat-no" title="statement not covered" >            inclusive: true,</span>
...
<span class="fstat-no" title="function not covered" >    multipleOf(value, message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({</span>
<span class="cstat-no" title="statement not covered" >            kind: "multipleOf",</span>
<span class="cstat-no" title="statement not covered" >            value: value,</span>
<span class="cstat-no" title="statement not covered" >            message: errorUtil.toString(message),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    finite(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({</span>
<span class="cstat-no" title="statement not covered" >            kind: "finite",</span>
<span class="cstat-no" title="statement not covered" >            message: errorUtil.toString(message),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    safe(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({</span>
<span class="cstat-no" title="statement not covered" >            kind: "min",</span>
<span class="cstat-no" title="statement not covered" >            inclusive: true,</span>
<span class="cstat-no" title="statement not covered" >            value: Number.MIN_SAFE_INTEGER,</span>
<span class="cstat-no" title="statement not covered" >            message: errorUtil.toString(message),</span>
<span class="cstat-no" title="statement not covered" >        })._addCheck({</span>
<span class="cstat-no" title="statement not covered" >            kind: "max",</span>
<span class="cstat-no" title="statement not covered" >            inclusive: true,</span>
<span class="cstat-no" title="statement not covered" >            value: Number.MAX_SAFE_INTEGER,</span>
<span class="cstat-no" title="statement not covered" >            message: errorUtil.toString(message),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get minValue() {</span>
<span class="cstat-no" title="statement not covered" >        let min = null;</span>
<span class="cstat-no" title="statement not covered" >        for (const ch of this._def.checks) {</span>
<span class="cstat-no" title="statement not covered" >            if (ch.kind === "min") {</span>
<span class="cstat-no" title="statement not covered" >                if (min === null || ch.value &gt; min)</span>
...
<span class="cstat-no" title="statement not covered" >        return min;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get maxValue() {</span>
<span class="cstat-no" title="statement not covered" >        let max = null;</span>
<span class="cstat-no" title="statement not covered" >        for (const ch of this._def.checks) {</span>
<span class="cstat-no" title="statement not covered" >            if (ch.kind === "max") {</span>
<span class="cstat-no" title="statement not covered" >                if (max === null || ch.value &lt; max)</span>
...
<span class="cstat-no" title="statement not covered" >        return max;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get isInt() {</span>
<span class="cstat-no" title="statement not covered" >        return !!this._def.checks.find((ch) =&gt; ch.kind === "int" || (ch.kind === "multipleOf" &amp;&amp; util.isInteger(ch.value)));</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get isFinite() {</span>
<span class="cstat-no" title="statement not covered" >        let max = null;</span>
<span class="cstat-no" title="statement not covered" >        let min = null;</span>
<span class="cstat-no" title="statement not covered" >        for (const ch of this._def.checks) {</span>
<span class="cstat-no" title="statement not covered" >            if (ch.kind === "finite" || ch.kind === "int" || ch.kind === "multipleOf") {</span>
<span class="cstat-no" title="statement not covered" >                return true;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (ch.kind === "min") {</span>
<span class="cstat-no" title="statement not covered" >                if (min === null || ch.value &gt; min)</span>
<span class="cstat-no" title="statement not covered" >                    min = ch.value;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (ch.kind === "max") {</span>
<span class="cstat-no" title="statement not covered" >                if (max === null || ch.value &lt; max)</span>
<span class="cstat-no" title="statement not covered" >                    max = ch.value;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return Number.isFinite(min) &amp;&amp; Number.isFinite(max);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
...
<span class="cstat-no" title="statement not covered" >        super(...arguments);</span>
<span class="cstat-no" title="statement not covered" >        this.min = this.gte;</span>
<span class="cstat-no" title="statement not covered" >        this.max = this.lte;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        if (this._def.coerce) {</span>
<span class="cstat-no" title="statement not covered" >            try {</span>
<span class="cstat-no" title="statement not covered" >                input.data = BigInt(input.data);</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            catch {</span>
<span class="cstat-no" title="statement not covered" >                return this._getInvalidInput(input);</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        const parsedType = this._getType(input);</span>
<span class="cstat-no" title="statement not covered" >        if (parsedType !== ZodParsedType.bigint) {</span>
<span class="cstat-no" title="statement not covered" >            return this._getInvalidInput(input);</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        let ctx = undefined;</span>
<span class="cstat-no" title="statement not covered" >        const status = new ParseStatus();</span>
<span class="cstat-no" title="statement not covered" >        for (const check of this._def.checks) {</span>
<span class="cstat-no" title="statement not covered" >            if (check.kind === "min") {</span>
<span class="cstat-no" title="statement not covered" >                const tooSmall = check.inclusive ? input.data &lt; check.value : input.data &lt;= check.value;</span>
<span class="cstat-no" title="statement not covered" >                if (tooSmall) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.too_small,</span>
...
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else if (check.kind === "multipleOf") {</span>
<span class="cstat-no" title="statement not covered" >                if (input.data % check.value !== BigInt(0)) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.not_multiple_of,</span>
<span class="cstat-no" title="statement not covered" >                        multipleOf: check.value,</span>
...
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return { status: status.value, value: input.data };</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    _getInvalidInput(input) {</span>
<span class="cstat-no" title="statement not covered" >        const ctx = this._getOrReturnCtx(input);</span>
<span class="cstat-no" title="statement not covered" >        addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >            code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >            expected: ZodParsedType.bigint,</span>
<span class="cstat-no" title="statement not covered" >            received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >        return INVALID;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
...
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    setLimit(kind, value, inclusive, message) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodBigInt({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            checks: [</span>
<span class="cstat-no" title="statement not covered" >                ...this._def.checks,</span>
<span class="cstat-no" title="statement not covered" >                {</span>
...
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    _addCheck(check) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodBigInt({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            checks: [...this._def.checks, check],</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    positive(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({</span>
<span class="cstat-no" title="statement not covered" >            kind: "min",</span>
<span class="cstat-no" title="statement not covered" >            value: BigInt(0),</span>
<span class="cstat-no" title="statement not covered" >            inclusive: false,</span>
<span class="cstat-no" title="statement not covered" >            message: errorUtil.toString(message),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
...
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    nonnegative(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({</span>
<span class="cstat-no" title="statement not covered" >            kind: "min",</span>
<span class="cstat-no" title="statement not covered" >            value: BigInt(0),</span>
<span class="cstat-no" title="statement not covered" >            inclusive: true,</span>
...
ZodBigInt.create = <span class="fstat-no" title="function not covered" >(params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodBigInt({</span>
<span class="cstat-no" title="statement not covered" >        checks: [],</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodBigInt,</span>
<span class="cstat-no" title="statement not covered" >        coerce: params?.coerce ?? false,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
export class ZodBoolean extends ZodType {
    _parse(input) {
        if (this._def.coerce) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            input.data = Boolean(input.data);</span>
<span class="cstat-no" title="statement not covered" >        }</span>
        const parsedType = this._getType(input);
        if (parsedType !== ZodParsedType.boolean) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            const ctx = this._getOrReturnCtx(input);</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                expected: ZodParsedType.boolean,</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
...
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        if (this._def.coerce) {</span>
<span class="cstat-no" title="statement not covered" >            input.data = new Date(input.data);</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        const parsedType = this._getType(input);</span>
<span class="cstat-no" title="statement not covered" >        if (parsedType !== ZodParsedType.date) {</span>
<span class="cstat-no" title="statement not covered" >            const ctx = this._getOrReturnCtx(input);</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                expected: ZodParsedType.date,</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        if (Number.isNaN(input.data.getTime())) {</span>
<span class="cstat-no" title="statement not covered" >            const ctx = this._getOrReturnCtx(input);</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_date,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        const status = new ParseStatus();</span>
...
<span class="cstat-no" title="statement not covered" >        for (const check of this._def.checks) {</span>
<span class="cstat-no" title="statement not covered" >            if (check.kind === "min") {</span>
<span class="cstat-no" title="statement not covered" >                if (input.data.getTime() &lt; check.value) {</span>
<span class="cstat-no" title="statement not covered" >                    ctx = this._getOrReturnCtx(input, ctx);</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.too_small,</span>
<span class="cstat-no" title="statement not covered" >                        message: check.message,</span>
...
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return {</span>
<span class="cstat-no" title="statement not covered" >            status: status.value,</span>
<span class="cstat-no" title="statement not covered" >            value: new Date(input.data.getTime()),</span>
<span class="cstat-no" title="statement not covered" >        };</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    _addCheck(check) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodDate({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            checks: [...this._def.checks, check],</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    min(minDate, message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({</span>
<span class="cstat-no" title="statement not covered" >            kind: "min",</span>
<span class="cstat-no" title="statement not covered" >            value: minDate.getTime(),</span>
<span class="cstat-no" title="statement not covered" >            message: errorUtil.toString(message),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    max(maxDate, message) {</span>
<span class="cstat-no" title="statement not covered" >        return this._addCheck({</span>
<span class="cstat-no" title="statement not covered" >            kind: "max",</span>
<span class="cstat-no" title="statement not covered" >            value: maxDate.getTime(),</span>
<span class="cstat-no" title="statement not covered" >            message: errorUtil.toString(message),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get minDate() {</span>
<span class="cstat-no" title="statement not covered" >        let min = null;</span>
<span class="cstat-no" title="statement not covered" >        for (const ch of this._def.checks) {</span>
<span class="cstat-no" title="statement not covered" >            if (ch.kind === "min") {</span>
<span class="cstat-no" title="statement not covered" >                if (min === null || ch.value &gt; min)</span>
...
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return min != null ? new Date(min) : null;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get maxDate() {</span>
<span class="cstat-no" title="statement not covered" >        let max = null;</span>
<span class="cstat-no" title="statement not covered" >        for (const ch of this._def.checks) {</span>
<span class="cstat-no" title="statement not covered" >            if (ch.kind === "max") {</span>
<span class="cstat-no" title="statement not covered" >                if (max === null || ch.value &lt; max)</span>
...
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return max != null ? new Date(max) : null;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
ZodDate.create = <span class="fstat-no" title="function not covered" >(params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodDate({</span>
<span class="cstat-no" title="statement not covered" >        checks: [],</span>
<span class="cstat-no" title="statement not covered" >        coerce: params?.coerce || false,</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodDate,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
...
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        const parsedType = this._getType(input);</span>
<span class="cstat-no" title="statement not covered" >        if (parsedType !== ZodParsedType.symbol) {</span>
<span class="cstat-no" title="statement not covered" >            const ctx = this._getOrReturnCtx(input);</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                expected: ZodParsedType.symbol,</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return OK(input.data);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
ZodSymbol.create = <span class="fstat-no" title="function not covered" >(params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodSymbol({</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodSymbol,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
...
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        const parsedType = this._getType(input);</span>
<span class="cstat-no" title="statement not covered" >        if (parsedType !== ZodParsedType.undefined) {</span>
<span class="cstat-no" title="statement not covered" >            const ctx = this._getOrReturnCtx(input);</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                expected: ZodParsedType.undefined,</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
...
ZodUndefined.create = <span class="fstat-no" title="function not covered" >(params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodUndefined({</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodUndefined,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
...
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        const parsedType = this._getType(input);</span>
<span class="cstat-no" title="statement not covered" >        if (parsedType !== ZodParsedType.null) {</span>
<span class="cstat-no" title="statement not covered" >            const ctx = this._getOrReturnCtx(input);</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                expected: ZodParsedType.null,</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
...
ZodNull.create = <span class="fstat-no" title="function not covered" >(params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodNull({</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodNull,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
...
<span class="fstat-no" title="function not covered" >    constructor() {</span>
<span class="cstat-no" title="statement not covered" >        super(...arguments);</span>
<span class="cstat-no" title="statement not covered" >        // to prevent instances of other classes from extending ZodAny. this causes issues with catchall in ZodObject.</span>
<span class="cstat-no" title="statement not covered" >        this._any = true;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        return OK(input.data);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
ZodAny.create = <span class="fstat-no" title="function not covered" >(params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodAny({</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodAny,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
...
<span class="cstat-no" title="statement not covered" >        this._unknown = true;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        return OK(input.data);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
ZodUnknown.create = <span class="fstat-no" title="function not covered" >(params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodUnknown({</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodUnknown,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
...
<span class="cstat-no" title="statement not covered" >        addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >            code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >            expected: ZodParsedType.never,</span>
<span class="cstat-no" title="statement not covered" >            received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >        return INVALID;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
...
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                expected: ZodParsedType.void,</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
...
ZodVoid.create = <span class="fstat-no" title="function not covered" >(params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodVoid({</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodVoid,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
export class ZodArray extends ZodType {
    _parse(input) {
        ...
        const def = this._def;
        if (ctx.parsedType !== ZodParsedType.array) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                expected: ZodParsedType.array,</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
        if (def.exactLength !== null) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            const tooBig = ctx.data.length &gt; def.exactLength.value;</span>
<span class="cstat-no" title="statement not covered" >            const tooSmall = ctx.data.length &lt; def.exactLength.value;</span>
<span class="cstat-no" title="statement not covered" >            if (tooBig || tooSmall) {</span>
<span class="cstat-no" title="statement not covered" >                addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                    code: tooBig ? ZodIssueCode.too_big : ZodIssueCode.too_small,</span>
<span class="cstat-no" title="statement not covered" >                    minimum: (tooSmall ? def.exactLength.value : undefined),</span>
<span class="cstat-no" title="statement not covered" >                    maximum: (tooBig ? def.exactLength.value : undefined),</span>
<span class="cstat-no" title="statement not covered" >                    type: "array",</span>
<span class="cstat-no" title="statement not covered" >                    inclusive: true,</span>
<span class="cstat-no" title="statement not covered" >                    exact: true,</span>
<span class="cstat-no" title="statement not covered" >                    message: def.exactLength.message,</span>
<span class="cstat-no" title="statement not covered" >                });</span>
<span class="cstat-no" title="statement not covered" >                status.dirty();</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
        if (def.minLength !== null) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            if (ctx.data.length &lt; def.minLength.value) {</span>
<span class="cstat-no" title="statement not covered" >                addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                    code: ZodIssueCode.too_small,</span>
<span class="cstat-no" title="statement not covered" >                    minimum: def.minLength.value,</span>
<span class="cstat-no" title="statement not covered" >                    type: "array",</span>
<span class="cstat-no" title="statement not covered" >                    inclusive: true,</span>
<span class="cstat-no" title="statement not covered" >                    exact: false,</span>
<span class="cstat-no" title="statement not covered" >                    message: def.minLength.message,</span>
<span class="cstat-no" title="statement not covered" >                });</span>
<span class="cstat-no" title="statement not covered" >                status.dirty();</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
        if (def.maxLength !== null) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            if (ctx.data.length &gt; def.maxLength.value) {</span>
<span class="cstat-no" title="statement not covered" >                addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                    code: ZodIssueCode.too_big,</span>
<span class="cstat-no" title="statement not covered" >                    maximum: def.maxLength.value,</span>
<span class="cstat-no" title="statement not covered" >                    type: "array",</span>
<span class="cstat-no" title="statement not covered" >                    inclusive: true,</span>
<span class="cstat-no" title="statement not covered" >                    exact: false,</span>
<span class="cstat-no" title="statement not covered" >                    message: def.maxLength.message,</span>
<span class="cstat-no" title="statement not covered" >                });</span>
<span class="cstat-no" title="statement not covered" >                status.dirty();</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
        if (ctx.common.async) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            return Promise.all([...ctx.data].map((item, i) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                return def.type._parseAsync(new ParseInputLazyPath(ctx, item, ctx.path, i));</span>
<span class="cstat-no" title="statement not covered" >            })).then((result) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                return ParseStatus.mergeArray(status, result);</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >        }</span>
...
<span class="fstat-no" title="function not covered" >    get element() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.type;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    min(minLength, message) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodArray({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            minLength: { value: minLength, message: errorUtil.toString(message) },</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    max(maxLength, message) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodArray({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            maxLength: { value: maxLength, message: errorUtil.toString(message) },</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    length(len, message) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodArray({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            exactLength: { value: len, message: errorUtil.toString(message) },</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    nonempty(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this.min(1, message);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
...
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function deepPartialify(schema) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (schema instanceof ZodObject) {</span>
<span class="cstat-no" title="statement not covered" >        const newShape = {};</span>
<span class="cstat-no" title="statement not covered" >        for (const key in schema.shape) {</span>
<span class="cstat-no" title="statement not covered" >            const fieldSchema = schema.shape[key];</span>
<span class="cstat-no" title="statement not covered" >            newShape[key] = ZodOptional.create(deepPartialify(fieldSchema));</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return new ZodObject({</span>
<span class="cstat-no" title="statement not covered" >            ...schema._def,</span>
<span class="cstat-no" title="statement not covered" >            shape: () =&gt; newShape,</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (schema instanceof ZodArray) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodArray({</span>
<span class="cstat-no" title="statement not covered" >            ...schema._def,</span>
<span class="cstat-no" title="statement not covered" >            type: deepPartialify(schema.element),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (schema instanceof ZodOptional) {</span>
<span class="cstat-no" title="statement not covered" >        return ZodOptional.create(deepPartialify(schema.unwrap()));</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (schema instanceof ZodNullable) {</span>
<span class="cstat-no" title="statement not covered" >        return ZodNullable.create(deepPartialify(schema.unwrap()));</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (schema instanceof ZodTuple) {</span>
<span class="cstat-no" title="statement not covered" >        return ZodTuple.create(schema.items.map((item) =&gt; deepPartialify(item)));</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else {</span>
...
<span class="branch-0 cbranch-no" title="branch not covered" >            return this._cached;</span>
    ...
    _parse(input) {
        const parsedType = this._getType(input);
        if (parsedType !== ZodParsedType.object) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            const ctx = this._getOrReturnCtx(input);</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                expected: ZodParsedType.object,</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
        ...
        const extraKeys = [];
        if (!(this._def.catchall instanceof ZodNever &amp;&amp; this._def.unknownKeys === "strip")) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            for (const key in ctx.data) {</span>
<span class="cstat-no" title="statement not covered" >                if (!shapeKeys.includes(key)) {</span>
<span class="cstat-no" title="statement not covered" >                    extraKeys.push(key);</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
        const pairs = [];
        ...
        if (this._def.catchall instanceof ZodNever) {
            ...
            if (unknownKeys === "passthrough") <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                for (const key of extraKeys) {</span>
<span class="cstat-no" title="statement not covered" >                    pairs.push({</span>
<span class="cstat-no" title="statement not covered" >                        key: { status: "valid", value: key },</span>
<span class="cstat-no" title="statement not covered" >                        value: { status: "valid", value: ctx.data[key] },</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
            else if (unknownKeys === "strict") <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >                if (extraKeys.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                    addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                        code: ZodIssueCode.unrecognized_keys,</span>
<span class="cstat-no" title="statement not covered" >                        keys: extraKeys,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
...
<span class="branch-0 cbranch-no" title="branch not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else {</span>
<span class="cstat-no" title="statement not covered" >                throw new Error(`Internal ZodObject error: invalid unknownKeys value.`);</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="branch-0 cbranch-no" title="branch not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        else {</span>
<span class="cstat-no" title="statement not covered" >            // run catchall validation</span>
<span class="cstat-no" title="statement not covered" >            const catchall = this._def.catchall;</span>
<span class="cstat-no" title="statement not covered" >            for (const key of extraKeys) {</span>
<span class="cstat-no" title="statement not covered" >                const value = ctx.data[key];</span>
<span class="cstat-no" title="statement not covered" >                pairs.push({</span>
<span class="cstat-no" title="statement not covered" >                    key: { status: "valid", value: key },</span>
<span class="cstat-no" title="statement not covered" >                    value: catchall._parse(new ParseInputLazyPath(ctx, value, ctx.path, key) //, ctx.child(key), value, getParsedType(value)</span>
<span class="cstat-no" title="statement not covered" >                    ),</span>
<span class="cstat-no" title="statement not covered" >                    alwaysSet: key in ctx.data,</span>
<span class="cstat-no" title="statement not covered" >                });</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
        if (ctx.common.async) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
...
<span class="cstat-no" title="statement not covered" >                const syncPairs = [];</span>
<span class="cstat-no" title="statement not covered" >                for (const pair of pairs) {</span>
<span class="cstat-no" title="statement not covered" >                    const key = await pair.key;</span>
<span class="cstat-no" title="statement not covered" >                    const value = await pair.value;</span>
<span class="cstat-no" title="statement not covered" >                    syncPairs.push({</span>
<span class="cstat-no" title="statement not covered" >                        key,</span>
<span class="cstat-no" title="statement not covered" >                        value,</span>
<span class="cstat-no" title="statement not covered" >                        alwaysSet: pair.alwaysSet,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                return syncPairs;</span>
<span class="cstat-no" title="statement not covered" >            })</span>
<span class="cstat-no" title="statement not covered" >                .then((syncPairs) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                return ParseStatus.mergeObjectSync(status, syncPairs);</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >        }</span>
        else {
...
<span class="fstat-no" title="function not covered" >    get shape() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.shape();</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    strict(message) {</span>
<span class="cstat-no" title="statement not covered" >        errorUtil.errToObj;</span>
<span class="cstat-no" title="statement not covered" >        return new ZodObject({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            unknownKeys: "strict",</span>
<span class="cstat-no" title="statement not covered" >            ...(message !== undefined</span>
<span class="cstat-no" title="statement not covered" >                ? {</span>
<span class="cstat-no" title="statement not covered" >                    errorMap: (issue, ctx) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                        const defaultError = this._def.errorMap?.(issue, ctx).message ?? ctx.defaultError;</span>
<span class="cstat-no" title="statement not covered" >                        if (issue.code === "unrecognized_keys")</span>
<span class="cstat-no" title="statement not covered" >                            return {</span>
<span class="cstat-no" title="statement not covered" >                                message: errorUtil.errToObj(message).message ?? defaultError,</span>
<span class="cstat-no" title="statement not covered" >                            };</span>
<span class="cstat-no" title="statement not covered" >                        return {</span>
<span class="cstat-no" title="statement not covered" >                            message: defaultError,</span>
<span class="cstat-no" title="statement not covered" >                        };</span>
<span class="cstat-no" title="statement not covered" >                    },</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                : {}),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    strip() {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodObject({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            unknownKeys: "strip",</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    passthrough() {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodObject({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            unknownKeys: "passthrough",</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    ...
    //     }) as any;
    //   };
<span class="fstat-no" title="function not covered" >    extend(augmentation) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodObject({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            shape: () =&gt; ({</span>
<span class="cstat-no" title="statement not covered" >                ...this._def.shape(),</span>
<span class="cstat-no" title="statement not covered" >                ...augmentation,</span>
<span class="cstat-no" title="statement not covered" >            }),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    /**
     ...
     */
<span class="fstat-no" title="function not covered" >    merge(merging) {</span>
<span class="cstat-no" title="statement not covered" >        const merged = new ZodObject({</span>
<span class="cstat-no" title="statement not covered" >            unknownKeys: merging._def.unknownKeys,</span>
<span class="cstat-no" title="statement not covered" >            catchall: merging._def.catchall,</span>
<span class="cstat-no" title="statement not covered" >            shape: () =&gt; ({</span>
<span class="cstat-no" title="statement not covered" >                ...this._def.shape(),</span>
<span class="cstat-no" title="statement not covered" >                ...merging._def.shape(),</span>
<span class="cstat-no" title="statement not covered" >            }),</span>
<span class="cstat-no" title="statement not covered" >            typeName: ZodFirstPartyTypeKind.ZodObject,</span>
<span class="cstat-no" title="statement not covered" >        });</span>
...
<span class="cstat-no" title="statement not covered" >    }</span>
    ...
    //   return merged;
    // }
<span class="fstat-no" title="function not covered" >    setKey(key, schema) {</span>
<span class="cstat-no" title="statement not covered" >        return this.augment({ [key]: schema });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    ...
    //   return merged;
    // }
<span class="fstat-no" title="function not covered" >    catchall(index) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodObject({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            catchall: index,</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    pick(mask) {</span>
<span class="cstat-no" title="statement not covered" >        const shape = {};</span>
<span class="cstat-no" title="statement not covered" >        for (const key of util.objectKeys(mask)) {</span>
<span class="cstat-no" title="statement not covered" >            if (mask[key] &amp;&amp; this.shape[key]) {</span>
<span class="cstat-no" title="statement not covered" >                shape[key] = this.shape[key];</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return new ZodObject({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            shape: () =&gt; shape,</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    omit(mask) {</span>
<span class="cstat-no" title="statement not covered" >        const shape = {};</span>
<span class="cstat-no" title="statement not covered" >        for (const key of util.objectKeys(this.shape)) {</span>
<span class="cstat-no" title="statement not covered" >            if (!mask[key]) {</span>
<span class="cstat-no" title="statement not covered" >                shape[key] = this.shape[key];</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return new ZodObject({</span>
...
<span class="cstat-no" title="statement not covered" >    }</span>
     ...
     * @deprecated
     */
<span class="fstat-no" title="function not covered" >    deepPartial() {</span>
<span class="cstat-no" title="statement not covered" >        return deepPartialify(this);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    partial(mask) {</span>
<span class="cstat-no" title="statement not covered" >        const newShape = {};</span>
<span class="cstat-no" title="statement not covered" >        for (const key of util.objectKeys(this.shape)) {</span>
<span class="cstat-no" title="statement not covered" >            const fieldSchema = this.shape[key];</span>
<span class="cstat-no" title="statement not covered" >            if (mask &amp;&amp; !mask[key]) {</span>
<span class="cstat-no" title="statement not covered" >                newShape[key] = fieldSchema;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else {</span>
<span class="cstat-no" title="statement not covered" >                newShape[key] = fieldSchema.optional();</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return new ZodObject({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
...
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    required(mask) {</span>
<span class="cstat-no" title="statement not covered" >        const newShape = {};</span>
<span class="cstat-no" title="statement not covered" >        for (const key of util.objectKeys(this.shape)) {</span>
<span class="cstat-no" title="statement not covered" >            if (mask &amp;&amp; !mask[key]) {</span>
<span class="cstat-no" title="statement not covered" >                newShape[key] = this.shape[key];</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else {</span>
<span class="cstat-no" title="statement not covered" >                const fieldSchema = this.shape[key];</span>
<span class="cstat-no" title="statement not covered" >                let newField = fieldSchema;</span>
<span class="cstat-no" title="statement not covered" >                while (newField instanceof ZodOptional) {</span>
<span class="cstat-no" title="statement not covered" >                    newField = newField._def.innerType;</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                newShape[key] = newField;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return new ZodObject({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
...
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    keyof() {</span>
<span class="cstat-no" title="statement not covered" >        return createZodEnum(util.objectKeys(this.shape));</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
...
ZodObject.strictCreate = <span class="fstat-no" title="function not covered" >(shape, params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodObject({</span>
<span class="cstat-no" title="statement not covered" >        shape: () =&gt; shape,</span>
<span class="cstat-no" title="statement not covered" >        unknownKeys: "strict",</span>
<span class="cstat-no" title="statement not covered" >        catchall: ZodNever.create(),</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodObject,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
ZodObject.lazycreate = <span class="fstat-no" title="function not covered" >(shape, params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodObject({</span>
<span class="cstat-no" title="statement not covered" >        shape,</span>
<span class="cstat-no" title="statement not covered" >        unknownKeys: "strip",</span>
<span class="cstat-no" title="statement not covered" >        catchall: ZodNever.create(),</span>
...
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        const { ctx } = this._processInputParams(input);</span>
<span class="cstat-no" title="statement not covered" >        const options = this._def.options;</span>
<span class="cstat-no" title="statement not covered" >        function handleResults(results) {</span>
<span class="cstat-no" title="statement not covered" >            // return first issue-free validation if it exists</span>
<span class="cstat-no" title="statement not covered" >            for (const result of results) {</span>
<span class="cstat-no" title="statement not covered" >                if (result.result.status === "valid") {</span>
<span class="cstat-no" title="statement not covered" >                    return result.result;</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            for (const result of results) {</span>
<span class="cstat-no" title="statement not covered" >                if (result.result.status === "dirty") {</span>
<span class="cstat-no" title="statement not covered" >                    // add issues from dirty option</span>
<span class="cstat-no" title="statement not covered" >                    ctx.common.issues.push(...result.ctx.common.issues);</span>
<span class="cstat-no" title="statement not covered" >                    return result.result;</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            // return invalid</span>
<span class="cstat-no" title="statement not covered" >            const unionErrors = results.map((result) =&gt; new ZodError(result.ctx.common.issues));</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_union,</span>
<span class="cstat-no" title="statement not covered" >                unionErrors,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        if (ctx.common.async) {</span>
<span class="cstat-no" title="statement not covered" >            return Promise.all(options.map(async (option) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                const childCtx = {</span>
...
<span class="cstat-no" title="statement not covered" >                };</span>
<span class="cstat-no" title="statement not covered" >                return {</span>
<span class="cstat-no" title="statement not covered" >                    result: await option._parseAsync({</span>
<span class="cstat-no" title="statement not covered" >                        data: ctx.data,</span>
<span class="cstat-no" title="statement not covered" >                        path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                        parent: childCtx,</span>
<span class="cstat-no" title="statement not covered" >                    }),</span>
<span class="cstat-no" title="statement not covered" >                    ctx: childCtx,</span>
<span class="cstat-no" title="statement not covered" >                };</span>
<span class="cstat-no" title="statement not covered" >            })).then(handleResults);</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        else {</span>
<span class="cstat-no" title="statement not covered" >            let dirty = undefined;</span>
<span class="cstat-no" title="statement not covered" >            const issues = [];</span>
<span class="cstat-no" title="statement not covered" >            for (const option of options) {</span>
<span class="cstat-no" title="statement not covered" >                const childCtx = {</span>
<span class="cstat-no" title="statement not covered" >                    ...ctx,</span>
<span class="cstat-no" title="statement not covered" >                    common: {</span>
<span class="cstat-no" title="statement not covered" >                        ...ctx.common,</span>
...
<span class="cstat-no" title="statement not covered" >                    parent: null,</span>
<span class="cstat-no" title="statement not covered" >                };</span>
<span class="cstat-no" title="statement not covered" >                const result = option._parseSync({</span>
<span class="cstat-no" title="statement not covered" >                    data: ctx.data,</span>
<span class="cstat-no" title="statement not covered" >                    path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                    parent: childCtx,</span>
<span class="cstat-no" title="statement not covered" >                });</span>
<span class="cstat-no" title="statement not covered" >                if (result.status === "valid") {</span>
<span class="cstat-no" title="statement not covered" >                    return result;</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                else if (result.status === "dirty" &amp;&amp; !dirty) {</span>
<span class="cstat-no" title="statement not covered" >                    dirty = { result, ctx: childCtx };</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                if (childCtx.common.issues.length) {</span>
<span class="cstat-no" title="statement not covered" >                    issues.push(childCtx.common.issues);</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            if (dirty) {</span>
<span class="cstat-no" title="statement not covered" >                ctx.common.issues.push(...dirty.ctx.common.issues);</span>
<span class="cstat-no" title="statement not covered" >                return dirty.result;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            const unionErrors = issues.map((issues) =&gt; new ZodError(issues));</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_union,</span>
<span class="cstat-no" title="statement not covered" >                unionErrors,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
...
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get options() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.options;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
ZodUnion.create = <span class="fstat-no" title="function not covered" >(types, params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodUnion({</span>
<span class="cstat-no" title="statement not covered" >        options: types,</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodUnion,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
/////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////
/////////////////////////////////////////////////////
const getDiscriminator = <span class="fstat-no" title="function not covered" >(type) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    if (type instanceof ZodLazy) {</span>
<span class="cstat-no" title="statement not covered" >        return getDiscriminator(type.schema);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (type instanceof ZodEffects) {</span>
<span class="cstat-no" title="statement not covered" >        return getDiscriminator(type.innerType());</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (type instanceof ZodLiteral) {</span>
<span class="cstat-no" title="statement not covered" >        return [type.value];</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (type instanceof ZodEnum) {</span>
<span class="cstat-no" title="statement not covered" >        return type.options;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (type instanceof ZodNativeEnum) {</span>
<span class="cstat-no" title="statement not covered" >        // eslint-disable-next-line ban/ban</span>
<span class="cstat-no" title="statement not covered" >        return util.objectValues(type.enum);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (type instanceof ZodDefault) {</span>
<span class="cstat-no" title="statement not covered" >        return getDiscriminator(type._def.innerType);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (type instanceof ZodUndefined) {</span>
<span class="cstat-no" title="statement not covered" >        return [undefined];</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (type instanceof ZodNull) {</span>
<span class="cstat-no" title="statement not covered" >        return [null];</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (type instanceof ZodOptional) {</span>
<span class="cstat-no" title="statement not covered" >        return [undefined, ...getDiscriminator(type.unwrap())];</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (type instanceof ZodNullable) {</span>
<span class="cstat-no" title="statement not covered" >        return [null, ...getDiscriminator(type.unwrap())];</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (type instanceof ZodBranded) {</span>
<span class="cstat-no" title="statement not covered" >        return getDiscriminator(type.unwrap());</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (type instanceof ZodReadonly) {</span>
<span class="cstat-no" title="statement not covered" >        return getDiscriminator(type.unwrap());</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (type instanceof ZodCatch) {</span>
<span class="cstat-no" title="statement not covered" >        return getDiscriminator(type._def.innerType);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else {</span>
<span class="cstat-no" title="statement not covered" >        return [];</span>
...
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        const { ctx } = this._processInputParams(input);</span>
<span class="cstat-no" title="statement not covered" >        if (ctx.parsedType !== ZodParsedType.object) {</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                expected: ZodParsedType.object,</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
...
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        const discriminator = this.discriminator;</span>
<span class="cstat-no" title="statement not covered" >        const discriminatorValue = ctx.data[discriminator];</span>
<span class="cstat-no" title="statement not covered" >        const option = this.optionsMap.get(discriminatorValue);</span>
<span class="cstat-no" title="statement not covered" >        if (!option) {</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_union_discriminator,</span>
<span class="cstat-no" title="statement not covered" >                options: Array.from(this.optionsMap.keys()),</span>
<span class="cstat-no" title="statement not covered" >                path: [discriminator],</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        if (ctx.common.async) {</span>
<span class="cstat-no" title="statement not covered" >            return option._parseAsync({</span>
<span class="cstat-no" title="statement not covered" >                data: ctx.data,</span>
<span class="cstat-no" title="statement not covered" >                path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                parent: ctx,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        else {</span>
<span class="cstat-no" title="statement not covered" >            return option._parseSync({</span>
<span class="cstat-no" title="statement not covered" >                data: ctx.data,</span>
<span class="cstat-no" title="statement not covered" >                path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                parent: ctx,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get discriminator() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.discriminator;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get options() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.options;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get optionsMap() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.optionsMap;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    /**
     ...
     * @param params
     */
    static <span class="fstat-no" title="function not covered" >create(discriminator, options, params) {</span>
<span class="cstat-no" title="statement not covered" >        // Get all the valid discriminator values</span>
<span class="cstat-no" title="statement not covered" >        const optionsMap = new Map();</span>
<span class="cstat-no" title="statement not covered" >        // try {</span>
<span class="cstat-no" title="statement not covered" >        for (const type of options) {</span>
<span class="cstat-no" title="statement not covered" >            const discriminatorValues = getDiscriminator(type.shape[discriminator]);</span>
<span class="cstat-no" title="statement not covered" >            if (!discriminatorValues.length) {</span>
<span class="cstat-no" title="statement not covered" >                throw new Error(`A discriminator value for key \`${discriminator}\` could not be extracted from all schema options`);</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            for (const value of discriminatorValues) {</span>
<span class="cstat-no" title="statement not covered" >                if (optionsMap.has(value)) {</span>
<span class="cstat-no" title="statement not covered" >                    throw new Error(`Discriminator property ${String(discriminator)} has duplicate value ${String(value)}`);</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                optionsMap.set(value, type);</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return new ZodDiscriminatedUnion({</span>
<span class="cstat-no" title="statement not covered" >            typeName: ZodFirstPartyTypeKind.ZodDiscriminatedUnion,</span>
<span class="cstat-no" title="statement not covered" >            discriminator,</span>
<span class="cstat-no" title="statement not covered" >            options,</span>
<span class="cstat-no" title="statement not covered" >            optionsMap,</span>
<span class="cstat-no" title="statement not covered" >            ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function mergeValues(a, b) {</span></span>
<span class="cstat-no" title="statement not covered" >    const aType = getParsedType(a);</span>
<span class="cstat-no" title="statement not covered" >    const bType = getParsedType(b);</span>
<span class="cstat-no" title="statement not covered" >    if (a === b) {</span>
<span class="cstat-no" title="statement not covered" >        return { valid: true, data: a };</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (aType === ZodParsedType.object &amp;&amp; bType === ZodParsedType.object) {</span>
<span class="cstat-no" title="statement not covered" >        const bKeys = util.objectKeys(b);</span>
<span class="cstat-no" title="statement not covered" >        const sharedKeys = util.objectKeys(a).filter((key) =&gt; bKeys.indexOf(key) !== -1);</span>
<span class="cstat-no" title="statement not covered" >        const newObj = { ...a, ...b };</span>
<span class="cstat-no" title="statement not covered" >        for (const key of sharedKeys) {</span>
<span class="cstat-no" title="statement not covered" >            const sharedValue = mergeValues(a[key], b[key]);</span>
<span class="cstat-no" title="statement not covered" >            if (!sharedValue.valid) {</span>
<span class="cstat-no" title="statement not covered" >                return { valid: false };</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            newObj[key] = sharedValue.data;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return { valid: true, data: newObj };</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (aType === ZodParsedType.array &amp;&amp; bType === ZodParsedType.array) {</span>
<span class="cstat-no" title="statement not covered" >        if (a.length !== b.length) {</span>
<span class="cstat-no" title="statement not covered" >            return { valid: false };</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        const newArray = [];</span>
<span class="cstat-no" title="statement not covered" >        for (let index = 0; index &lt; a.length; index++) {</span>
<span class="cstat-no" title="statement not covered" >            const itemA = a[index];</span>
<span class="cstat-no" title="statement not covered" >            const itemB = b[index];</span>
<span class="cstat-no" title="statement not covered" >            const sharedValue = mergeValues(itemA, itemB);</span>
<span class="cstat-no" title="statement not covered" >            if (!sharedValue.valid) {</span>
<span class="cstat-no" title="statement not covered" >                return { valid: false };</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            newArray.push(sharedValue.data);</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return { valid: true, data: newArray };</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else if (aType === ZodParsedType.date &amp;&amp; bType === ZodParsedType.date &amp;&amp; +a === +b) {</span>
<span class="cstat-no" title="statement not covered" >        return { valid: true, data: a };</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    else {</span>
<span class="cstat-no" title="statement not covered" >        return { valid: false };</span>
...
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        const { status, ctx } = this._processInputParams(input);</span>
<span class="cstat-no" title="statement not covered" >        const handleParsed = (parsedLeft, parsedRight) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            if (isAborted(parsedLeft) || isAborted(parsedRight)) {</span>
<span class="cstat-no" title="statement not covered" >                return INVALID;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            const merged = mergeValues(parsedLeft.value, parsedRight.value);</span>
<span class="cstat-no" title="statement not covered" >            if (!merged.valid) {</span>
<span class="cstat-no" title="statement not covered" >                addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                    code: ZodIssueCode.invalid_intersection_types,</span>
<span class="cstat-no" title="statement not covered" >                });</span>
<span class="cstat-no" title="statement not covered" >                return INVALID;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            if (isDirty(parsedLeft) || isDirty(parsedRight)) {</span>
<span class="cstat-no" title="statement not covered" >                status.dirty();</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            return { status: status.value, value: merged.data };</span>
<span class="cstat-no" title="statement not covered" >        };</span>
<span class="cstat-no" title="statement not covered" >        if (ctx.common.async) {</span>
<span class="cstat-no" title="statement not covered" >            return Promise.all([</span>
<span class="cstat-no" title="statement not covered" >                this._def.left._parseAsync({</span>
<span class="cstat-no" title="statement not covered" >                    data: ctx.data,</span>
<span class="cstat-no" title="statement not covered" >                    path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                    parent: ctx,</span>
<span class="cstat-no" title="statement not covered" >                }),</span>
<span class="cstat-no" title="statement not covered" >                this._def.right._parseAsync({</span>
<span class="cstat-no" title="statement not covered" >                    data: ctx.data,</span>
<span class="cstat-no" title="statement not covered" >                    path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                    parent: ctx,</span>
<span class="cstat-no" title="statement not covered" >                }),</span>
<span class="cstat-no" title="statement not covered" >            ]).then(([left, right]) =&gt; handleParsed(left, right));</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        else {</span>
<span class="cstat-no" title="statement not covered" >            return handleParsed(this._def.left._parseSync({</span>
<span class="cstat-no" title="statement not covered" >                data: ctx.data,</span>
<span class="cstat-no" title="statement not covered" >                path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                parent: ctx,</span>
<span class="cstat-no" title="statement not covered" >            }), this._def.right._parseSync({</span>
<span class="cstat-no" title="statement not covered" >                data: ctx.data,</span>
<span class="cstat-no" title="statement not covered" >                path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                parent: ctx,</span>
<span class="cstat-no" title="statement not covered" >            }));</span>
...
ZodIntersection.create = <span class="fstat-no" title="function not covered" >(left, right, params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodIntersection({</span>
<span class="cstat-no" title="statement not covered" >        left: left,</span>
<span class="cstat-no" title="statement not covered" >        right: right,</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodIntersection,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
...
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        const { status, ctx } = this._processInputParams(input);</span>
<span class="cstat-no" title="statement not covered" >        if (ctx.parsedType !== ZodParsedType.array) {</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                expected: ZodParsedType.array,</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
...
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        if (ctx.data.length &lt; this._def.items.length) {</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.too_small,</span>
<span class="cstat-no" title="statement not covered" >                minimum: this._def.items.length,</span>
<span class="cstat-no" title="statement not covered" >                inclusive: true,</span>
<span class="cstat-no" title="statement not covered" >                exact: false,</span>
<span class="cstat-no" title="statement not covered" >                type: "array",</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        const rest = this._def.rest;</span>
<span class="cstat-no" title="statement not covered" >        if (!rest &amp;&amp; ctx.data.length &gt; this._def.items.length) {</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.too_big,</span>
<span class="cstat-no" title="statement not covered" >                maximum: this._def.items.length,</span>
<span class="cstat-no" title="statement not covered" >                inclusive: true,</span>
<span class="cstat-no" title="statement not covered" >                exact: false,</span>
<span class="cstat-no" title="statement not covered" >                type: "array",</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            status.dirty();</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        const items = [...ctx.data]</span>
<span class="cstat-no" title="statement not covered" >            .map((item, itemIndex) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            const schema = this._def.items[itemIndex] || this._def.rest;</span>
<span class="cstat-no" title="statement not covered" >            if (!schema)</span>
<span class="cstat-no" title="statement not covered" >                return null;</span>
<span class="cstat-no" title="statement not covered" >            return schema._parse(new ParseInputLazyPath(ctx, item, ctx.path, itemIndex));</span>
<span class="cstat-no" title="statement not covered" >        })</span>
<span class="cstat-no" title="statement not covered" >            .filter((x) =&gt; !!x); // filter nulls</span>
<span class="cstat-no" title="statement not covered" >        if (ctx.common.async) {</span>
<span class="cstat-no" title="statement not covered" >            return Promise.all(items).then((results) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                return ParseStatus.mergeArray(status, results);</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        else {</span>
<span class="cstat-no" title="statement not covered" >            return ParseStatus.mergeArray(status, items);</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get items() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.items;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    rest(rest) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodTuple({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            rest,</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
ZodTuple.create = <span class="fstat-no" title="function not covered" >(schemas, params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    if (!Array.isArray(schemas)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error("You must pass an array of schemas to z.tuple([ ... ])");</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    return new ZodTuple({</span>
<span class="cstat-no" title="statement not covered" >        items: schemas,</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodTuple,</span>
<span class="cstat-no" title="statement not covered" >        rest: null,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
export class ZodRecord extends ZodType {
<span class="fstat-no" title="function not covered" >    get keySchema() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.keyType;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get valueSchema() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.valueType;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    _parse(input) {
        const { status, ctx } = this._processInputParams(input);
        if (ctx.parsedType !== ZodParsedType.object) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                expected: ZodParsedType.object,</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
...
<span class="cstat-no" title="statement not covered" >        }</span>
        ...
        if (ctx.common.async) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            return ParseStatus.mergeObjectAsync(status, pairs);</span>
<span class="cstat-no" title="statement not covered" >        }</span>
        else {
            return ParseStatus.mergeObjectSync(status, pairs);
        }
...
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        const { status, ctx } = this._processInputParams(input);</span>
<span class="cstat-no" title="statement not covered" >        if (ctx.parsedType !== ZodParsedType.map) {</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                expected: ZodParsedType.map,</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        const keyType = this._def.keyType;</span>
<span class="cstat-no" title="statement not covered" >        const valueType = this._def.valueType;</span>
<span class="cstat-no" title="statement not covered" >        const pairs = [...ctx.data.entries()].map(([key, value], index) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            return {</span>
<span class="cstat-no" title="statement not covered" >                key: keyType._parse(new ParseInputLazyPath(ctx, key, ctx.path, [index, "key"])),</span>
<span class="cstat-no" title="statement not covered" >                value: valueType._parse(new ParseInputLazyPath(ctx, value, ctx.path, [index, "value"])),</span>
<span class="cstat-no" title="statement not covered" >            };</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >        if (ctx.common.async) {</span>
<span class="cstat-no" title="statement not covered" >            const finalMap = new Map();</span>
<span class="cstat-no" title="statement not covered" >            return Promise.resolve().then(async () =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                for (const pair of pairs) {</span>
<span class="cstat-no" title="statement not covered" >                    const key = await pair.key;</span>
<span class="cstat-no" title="statement not covered" >                    const value = await pair.value;</span>
<span class="cstat-no" title="statement not covered" >                    if (key.status === "aborted" || value.status === "aborted") {</span>
<span class="cstat-no" title="statement not covered" >                        return INVALID;</span>
<span class="cstat-no" title="statement not covered" >                    }</span>
<span class="cstat-no" title="statement not covered" >                    if (key.status === "dirty" || value.status === "dirty") {</span>
<span class="cstat-no" title="statement not covered" >                        status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                    }</span>
<span class="cstat-no" title="statement not covered" >                    finalMap.set(key.value, value.value);</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                return { status: status.value, value: finalMap };</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        else {</span>
<span class="cstat-no" title="statement not covered" >            const finalMap = new Map();</span>
<span class="cstat-no" title="statement not covered" >            for (const pair of pairs) {</span>
<span class="cstat-no" title="statement not covered" >                const key = pair.key;</span>
<span class="cstat-no" title="statement not covered" >                const value = pair.value;</span>
<span class="cstat-no" title="statement not covered" >                if (key.status === "aborted" || value.status === "aborted") {</span>
<span class="cstat-no" title="statement not covered" >                    return INVALID;</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                if (key.status === "dirty" || value.status === "dirty") {</span>
...
ZodMap.create = <span class="fstat-no" title="function not covered" >(keyType, valueType, params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodMap({</span>
<span class="cstat-no" title="statement not covered" >        valueType,</span>
<span class="cstat-no" title="statement not covered" >        keyType,</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodMap,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
...
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        const { status, ctx } = this._processInputParams(input);</span>
<span class="cstat-no" title="statement not covered" >        if (ctx.parsedType !== ZodParsedType.set) {</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                expected: ZodParsedType.set,</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        const def = this._def;</span>
<span class="cstat-no" title="statement not covered" >        if (def.minSize !== null) {</span>
<span class="cstat-no" title="statement not covered" >            if (ctx.data.size &lt; def.minSize.value) {</span>
<span class="cstat-no" title="statement not covered" >                addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                    code: ZodIssueCode.too_small,</span>
<span class="cstat-no" title="statement not covered" >                    minimum: def.minSize.value,</span>
<span class="cstat-no" title="statement not covered" >                    type: "set",</span>
<span class="cstat-no" title="statement not covered" >                    inclusive: true,</span>
<span class="cstat-no" title="statement not covered" >                    exact: false,</span>
<span class="cstat-no" title="statement not covered" >                    message: def.minSize.message,</span>
<span class="cstat-no" title="statement not covered" >                });</span>
<span class="cstat-no" title="statement not covered" >                status.dirty();</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        if (def.maxSize !== null) {</span>
<span class="cstat-no" title="statement not covered" >            if (ctx.data.size &gt; def.maxSize.value) {</span>
<span class="cstat-no" title="statement not covered" >                addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                    code: ZodIssueCode.too_big,</span>
<span class="cstat-no" title="statement not covered" >                    maximum: def.maxSize.value,</span>
<span class="cstat-no" title="statement not covered" >                    type: "set",</span>
<span class="cstat-no" title="statement not covered" >                    inclusive: true,</span>
<span class="cstat-no" title="statement not covered" >                    exact: false,</span>
<span class="cstat-no" title="statement not covered" >                    message: def.maxSize.message,</span>
<span class="cstat-no" title="statement not covered" >                });</span>
<span class="cstat-no" title="statement not covered" >                status.dirty();</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        const valueType = this._def.valueType;</span>
<span class="cstat-no" title="statement not covered" >        function finalizeSet(elements) {</span>
<span class="cstat-no" title="statement not covered" >            const parsedSet = new Set();</span>
<span class="cstat-no" title="statement not covered" >            for (const element of elements) {</span>
<span class="cstat-no" title="statement not covered" >                if (element.status === "aborted")</span>
<span class="cstat-no" title="statement not covered" >                    return INVALID;</span>
<span class="cstat-no" title="statement not covered" >                if (element.status === "dirty")</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                parsedSet.add(element.value);</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            return { status: status.value, value: parsedSet };</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        const elements = [...ctx.data.values()].map((item, i) =&gt; valueType._parse(new ParseInputLazyPath(ctx, item, ctx.path, i)));</span>
<span class="cstat-no" title="statement not covered" >        if (ctx.common.async) {</span>
<span class="cstat-no" title="statement not covered" >            return Promise.all(elements).then((elements) =&gt; finalizeSet(elements));</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        else {</span>
<span class="cstat-no" title="statement not covered" >            return finalizeSet(elements);</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    min(minSize, message) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodSet({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            minSize: { value: minSize, message: errorUtil.toString(message) },</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    max(maxSize, message) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodSet({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            maxSize: { value: maxSize, message: errorUtil.toString(message) },</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    size(size, message) {</span>
<span class="cstat-no" title="statement not covered" >        return this.min(size, message).max(size, message);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    nonempty(message) {</span>
<span class="cstat-no" title="statement not covered" >        return this.min(1, message);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
ZodSet.create = <span class="fstat-no" title="function not covered" >(valueType, params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodSet({</span>
<span class="cstat-no" title="statement not covered" >        valueType,</span>
<span class="cstat-no" title="statement not covered" >        minSize: null,</span>
<span class="cstat-no" title="statement not covered" >        maxSize: null,</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodSet,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
...
<span class="fstat-no" title="function not covered" >    constructor() {</span>
<span class="cstat-no" title="statement not covered" >        super(...arguments);</span>
<span class="cstat-no" title="statement not covered" >        this.validate = this.implement;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        const { ctx } = this._processInputParams(input);</span>
<span class="cstat-no" title="statement not covered" >        if (ctx.parsedType !== ZodParsedType.function) {</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                expected: ZodParsedType.function,</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        function makeArgsIssue(args, error) {</span>
<span class="cstat-no" title="statement not covered" >            return makeIssue({</span>
<span class="cstat-no" title="statement not covered" >                data: args,</span>
<span class="cstat-no" title="statement not covered" >                path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                errorMaps: [ctx.common.contextualErrorMap, ctx.schemaErrorMap, getErrorMap(), defaultErrorMap].filter((x) =&gt; !!x),</span>
<span class="cstat-no" title="statement not covered" >                issueData: {</span>
<span class="cstat-no" title="statement not covered" >                    code: ZodIssueCode.invalid_arguments,</span>
<span class="cstat-no" title="statement not covered" >                    argumentsError: error,</span>
<span class="cstat-no" title="statement not covered" >                },</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        function makeReturnsIssue(returns, error) {</span>
<span class="cstat-no" title="statement not covered" >            return makeIssue({</span>
<span class="cstat-no" title="statement not covered" >                data: returns,</span>
<span class="cstat-no" title="statement not covered" >                path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                errorMaps: [ctx.common.contextualErrorMap, ctx.schemaErrorMap, getErrorMap(), defaultErrorMap].filter((x) =&gt; !!x),</span>
<span class="cstat-no" title="statement not covered" >                issueData: {</span>
<span class="cstat-no" title="statement not covered" >                    code: ZodIssueCode.invalid_return_type,</span>
<span class="cstat-no" title="statement not covered" >                    returnTypeError: error,</span>
<span class="cstat-no" title="statement not covered" >                },</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        const params = { errorMap: ctx.common.contextualErrorMap };</span>
<span class="cstat-no" title="statement not covered" >        const fn = ctx.data;</span>
<span class="cstat-no" title="statement not covered" >        if (this._def.returns instanceof ZodPromise) {</span>
<span class="cstat-no" title="statement not covered" >            // Would love a way to avoid disabling this rule, but we need</span>
<span class="cstat-no" title="statement not covered" >            // an alias (using an arrow function was what caused 2651).</span>
<span class="cstat-no" title="statement not covered" >            // eslint-disable-next-line @typescript-eslint/no-this-alias</span>
<span class="cstat-no" title="statement not covered" >            const me = this;</span>
<span class="cstat-no" title="statement not covered" >            return OK(async function (...args) {</span>
<span class="cstat-no" title="statement not covered" >                const error = new ZodError([]);</span>
<span class="cstat-no" title="statement not covered" >                const parsedArgs = await me._def.args.parseAsync(args, params).catch((e) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                    error.addIssue(makeArgsIssue(args, e));</span>
<span class="cstat-no" title="statement not covered" >                    throw error;</span>
<span class="cstat-no" title="statement not covered" >                });</span>
<span class="cstat-no" title="statement not covered" >                const result = await Reflect.apply(fn, this, parsedArgs);</span>
<span class="cstat-no" title="statement not covered" >                const parsedReturns = await me._def.returns._def.type</span>
<span class="cstat-no" title="statement not covered" >                    .parseAsync(result, params)</span>
<span class="cstat-no" title="statement not covered" >                    .catch((e) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                    error.addIssue(makeReturnsIssue(result, e));</span>
<span class="cstat-no" title="statement not covered" >                    throw error;</span>
<span class="cstat-no" title="statement not covered" >                });</span>
<span class="cstat-no" title="statement not covered" >                return parsedReturns;</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        else {</span>
<span class="cstat-no" title="statement not covered" >            // Would love a way to avoid disabling this rule, but we need</span>
...
<span class="cstat-no" title="statement not covered" >            // eslint-disable-next-line @typescript-eslint/no-this-alias</span>
<span class="cstat-no" title="statement not covered" >            const me = this;</span>
<span class="cstat-no" title="statement not covered" >            return OK(function (...args) {</span>
<span class="cstat-no" title="statement not covered" >                const parsedArgs = me._def.args.safeParse(args, params);</span>
<span class="cstat-no" title="statement not covered" >                if (!parsedArgs.success) {</span>
<span class="cstat-no" title="statement not covered" >                    throw new ZodError([makeArgsIssue(args, parsedArgs.error)]);</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                const result = Reflect.apply(fn, this, parsedArgs.data);</span>
<span class="cstat-no" title="statement not covered" >                const parsedReturns = me._def.returns.safeParse(result, params);</span>
<span class="cstat-no" title="statement not covered" >                if (!parsedReturns.success) {</span>
<span class="cstat-no" title="statement not covered" >                    throw new ZodError([makeReturnsIssue(result, parsedReturns.error)]);</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                return parsedReturns.data;</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    parameters() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.args;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    returnType() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.returns;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    args(...items) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodFunction({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            args: ZodTuple.create(items).rest(ZodUnknown.create()),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    returns(returnType) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodFunction({</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            returns: returnType,</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    implement(func) {</span>
<span class="cstat-no" title="statement not covered" >        const validatedFunc = this.parse(func);</span>
<span class="cstat-no" title="statement not covered" >        return validatedFunc;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    strictImplement(func) {</span>
<span class="cstat-no" title="statement not covered" >        const validatedFunc = this.parse(func);</span>
<span class="cstat-no" title="statement not covered" >        return validatedFunc;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    static <span class="fstat-no" title="function not covered" >create(args, returns, params) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodFunction({</span>
<span class="cstat-no" title="statement not covered" >            args: (args ? args : ZodTuple.create([]).rest(ZodUnknown.create())),</span>
<span class="cstat-no" title="statement not covered" >            returns: returns || ZodUnknown.create(),</span>
<span class="cstat-no" title="statement not covered" >            typeName: ZodFirstPartyTypeKind.ZodFunction,</span>
<span class="cstat-no" title="statement not covered" >            ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
export class ZodLazy extends ZodType {
<span class="fstat-no" title="function not covered" >    get schema() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.getter();</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        const { ctx } = this._processInputParams(input);</span>
<span class="cstat-no" title="statement not covered" >        const lazySchema = this._def.getter();</span>
<span class="cstat-no" title="statement not covered" >        return lazySchema._parse({ data: ctx.data, path: ctx.path, parent: ctx });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
ZodLazy.create = <span class="fstat-no" title="function not covered" >(getter, params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodLazy({</span>
<span class="cstat-no" title="statement not covered" >        getter: getter,</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodLazy,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
export class ZodLiteral extends ZodType {
    _parse(input) {
        if (input.data !== this._def.value) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            const ctx = this._getOrReturnCtx(input);</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.data,</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_literal,</span>
<span class="cstat-no" title="statement not covered" >                expected: this._def.value,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
        return { status: "valid", value: input.data };
    }
<span class="fstat-no" title="function not covered" >    get value() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.value;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
...
export class ZodEnum extends ZodType {
    _parse(input) {
        if (typeof input.data !== "string") <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            const ctx = this._getOrReturnCtx(input);</span>
<span class="cstat-no" title="statement not covered" >            const expectedValues = this._def.values;</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                expected: util.joinValues(expectedValues),</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
        ...
        if (!this._cache.has(input.data)) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            const ctx = this._getOrReturnCtx(input);</span>
<span class="cstat-no" title="statement not covered" >            const expectedValues = this._def.values;</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.data,</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_enum_value,</span>
<span class="cstat-no" title="statement not covered" >                options: expectedValues,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
        return OK(input.data);
...
<span class="fstat-no" title="function not covered" >    get options() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.values;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get enum() {</span>
<span class="cstat-no" title="statement not covered" >        const enumValues = {};</span>
<span class="cstat-no" title="statement not covered" >        for (const val of this._def.values) {</span>
<span class="cstat-no" title="statement not covered" >            enumValues[val] = val;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return enumValues;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    get Values() {</span>
<span class="cstat-no" title="statement not covered" >        const enumValues = {};</span>
<span class="cstat-no" title="statement not covered" >        for (const val of this._def.values) {</span>
<span class="cstat-no" title="statement not covered" >            enumValues[val] = val;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
...
<span class="cstat-no" title="statement not covered" >        return enumValues;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    extract(values, newDef = this._def) {</span>
<span class="cstat-no" title="statement not covered" >        return ZodEnum.create(values, {</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            ...newDef,</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    exclude(values, newDef = this._def) {</span>
<span class="cstat-no" title="statement not covered" >        return ZodEnum.create(this.options.filter((opt) =&gt; !values.includes(opt)), {</span>
<span class="cstat-no" title="statement not covered" >            ...this._def,</span>
<span class="cstat-no" title="statement not covered" >            ...newDef,</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
...
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        const nativeEnumValues = util.getValidEnumValues(this._def.values);</span>
<span class="cstat-no" title="statement not covered" >        const ctx = this._getOrReturnCtx(input);</span>
<span class="cstat-no" title="statement not covered" >        if (ctx.parsedType !== ZodParsedType.string &amp;&amp; ctx.parsedType !== ZodParsedType.number) {</span>
<span class="cstat-no" title="statement not covered" >            const expectedValues = util.objectValues(nativeEnumValues);</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                expected: util.joinValues(expectedValues),</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
...
<span class="cstat-no" title="statement not covered" >            this._cache = new Set(util.getValidEnumValues(this._def.values));</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        if (!this._cache.has(input.data)) {</span>
<span class="cstat-no" title="statement not covered" >            const expectedValues = util.objectValues(nativeEnumValues);</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.data,</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_enum_value,</span>
...
ZodNativeEnum.create = <span class="fstat-no" title="function not covered" >(values, params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodNativeEnum({</span>
<span class="cstat-no" title="statement not covered" >        values: values,</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodNativeEnum,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
export class ZodPromise extends ZodType {
<span class="fstat-no" title="function not covered" >    unwrap() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.type;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        const { ctx } = this._processInputParams(input);</span>
<span class="cstat-no" title="statement not covered" >        if (ctx.parsedType !== ZodParsedType.promise &amp;&amp; ctx.common.async === false) {</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                expected: ZodParsedType.promise,</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        const promisified = ctx.parsedType === ZodParsedType.promise ? ctx.data : Promise.resolve(ctx.data);</span>
<span class="cstat-no" title="statement not covered" >        return OK(promisified.then((data) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            return this._def.type.parseAsync(data, {</span>
<span class="cstat-no" title="statement not covered" >                path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                errorMap: ctx.common.contextualErrorMap,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >        }));</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
ZodPromise.create = <span class="fstat-no" title="function not covered" >(schema, params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodPromise({</span>
<span class="cstat-no" title="statement not covered" >        type: schema,</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodPromise,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
export class ZodEffects extends ZodType {
<span class="fstat-no" title="function not covered" >    innerType() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.schema;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    sourceType() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.schema._def.typeName === ZodFirstPartyTypeKind.ZodEffects</span>
<span class="cstat-no" title="statement not covered" >            ? this._def.schema.sourceType()</span>
<span class="cstat-no" title="statement not covered" >            : this._def.schema;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        const { status, ctx } = this._processInputParams(input);</span>
<span class="cstat-no" title="statement not covered" >        const effect = this._def.effect || null;</span>
<span class="cstat-no" title="statement not covered" >        const checkCtx = {</span>
<span class="cstat-no" title="statement not covered" >            addIssue: (arg) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                addIssueToContext(ctx, arg);</span>
<span class="cstat-no" title="statement not covered" >                if (arg.fatal) {</span>
<span class="cstat-no" title="statement not covered" >                    status.abort();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                else {</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            },</span>
<span class="cstat-no" title="statement not covered" >            get path() {</span>
<span class="cstat-no" title="statement not covered" >                return ctx.path;</span>
<span class="cstat-no" title="statement not covered" >            },</span>
<span class="cstat-no" title="statement not covered" >        };</span>
<span class="cstat-no" title="statement not covered" >        checkCtx.addIssue = checkCtx.addIssue.bind(checkCtx);</span>
<span class="cstat-no" title="statement not covered" >        if (effect.type === "preprocess") {</span>
<span class="cstat-no" title="statement not covered" >            const processed = effect.transform(ctx.data, checkCtx);</span>
<span class="cstat-no" title="statement not covered" >            if (ctx.common.async) {</span>
<span class="cstat-no" title="statement not covered" >                return Promise.resolve(processed).then(async (processed) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                    if (status.value === "aborted")</span>
<span class="cstat-no" title="statement not covered" >                        return INVALID;</span>
<span class="cstat-no" title="statement not covered" >                    const result = await this._def.schema._parseAsync({</span>
<span class="cstat-no" title="statement not covered" >                        data: processed,</span>
<span class="cstat-no" title="statement not covered" >                        path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                        parent: ctx,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                    if (result.status === "aborted")</span>
<span class="cstat-no" title="statement not covered" >                        return INVALID;</span>
<span class="cstat-no" title="statement not covered" >                    if (result.status === "dirty")</span>
<span class="cstat-no" title="statement not covered" >                        return DIRTY(result.value);</span>
<span class="cstat-no" title="statement not covered" >                    if (status.value === "dirty")</span>
<span class="cstat-no" title="statement not covered" >                        return DIRTY(result.value);</span>
<span class="cstat-no" title="statement not covered" >                    return result;</span>
<span class="cstat-no" title="statement not covered" >                });</span>
<span class="cstat-no" title="statement not covered" >            }</span>
...
<span class="cstat-no" title="statement not covered" >                if (status.value === "aborted")</span>
<span class="cstat-no" title="statement not covered" >                    return INVALID;</span>
<span class="cstat-no" title="statement not covered" >                const result = this._def.schema._parseSync({</span>
<span class="cstat-no" title="statement not covered" >                    data: processed,</span>
<span class="cstat-no" title="statement not covered" >                    path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                    parent: ctx,</span>
<span class="cstat-no" title="statement not covered" >                });</span>
...
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        if (effect.type === "refinement") {</span>
<span class="cstat-no" title="statement not covered" >            const executeRefinement = (acc) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                const result = effect.refinement(acc, checkCtx);</span>
<span class="cstat-no" title="statement not covered" >                if (ctx.common.async) {</span>
<span class="cstat-no" title="statement not covered" >                    return Promise.resolve(result);</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                if (result instanceof Promise) {</span>
<span class="cstat-no" title="statement not covered" >                    throw new Error("Async refinement encountered during synchronous parse operation. Use .parseAsync instead.");</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                return acc;</span>
<span class="cstat-no" title="statement not covered" >            };</span>
<span class="cstat-no" title="statement not covered" >            if (ctx.common.async === false) {</span>
<span class="cstat-no" title="statement not covered" >                const inner = this._def.schema._parseSync({</span>
<span class="cstat-no" title="statement not covered" >                    data: ctx.data,</span>
<span class="cstat-no" title="statement not covered" >                    path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                    parent: ctx,</span>
<span class="cstat-no" title="statement not covered" >                });</span>
<span class="cstat-no" title="statement not covered" >                if (inner.status === "aborted")</span>
<span class="cstat-no" title="statement not covered" >                    return INVALID;</span>
<span class="cstat-no" title="statement not covered" >                if (inner.status === "dirty")</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                // return value is ignored</span>
<span class="cstat-no" title="statement not covered" >                executeRefinement(inner.value);</span>
<span class="cstat-no" title="statement not covered" >                return { status: status.value, value: inner.value };</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else {</span>
<span class="cstat-no" title="statement not covered" >                return this._def.schema._parseAsync({ data: ctx.data, path: ctx.path, parent: ctx }).then((inner) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                    if (inner.status === "aborted")</span>
<span class="cstat-no" title="statement not covered" >                        return INVALID;</span>
<span class="cstat-no" title="statement not covered" >                    if (inner.status === "dirty")</span>
<span class="cstat-no" title="statement not covered" >                        status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                    return executeRefinement(inner.value).then(() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                        return { status: status.value, value: inner.value };</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                });</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        if (effect.type === "transform") {</span>
<span class="cstat-no" title="statement not covered" >            if (ctx.common.async === false) {</span>
<span class="cstat-no" title="statement not covered" >                const base = this._def.schema._parseSync({</span>
<span class="cstat-no" title="statement not covered" >                    data: ctx.data,</span>
<span class="cstat-no" title="statement not covered" >                    path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                    parent: ctx,</span>
<span class="cstat-no" title="statement not covered" >                });</span>
<span class="cstat-no" title="statement not covered" >                if (!isValid(base))</span>
<span class="cstat-no" title="statement not covered" >                    return INVALID;</span>
<span class="cstat-no" title="statement not covered" >                const result = effect.transform(base.value, checkCtx);</span>
<span class="cstat-no" title="statement not covered" >                if (result instanceof Promise) {</span>
<span class="cstat-no" title="statement not covered" >                    throw new Error(`Asynchronous transform encountered during synchronous parse operation. Use .parseAsync instead.`);</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                return { status: status.value, value: result };</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else {</span>
<span class="cstat-no" title="statement not covered" >                return this._def.schema._parseAsync({ data: ctx.data, path: ctx.path, parent: ctx }).then((base) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                    if (!isValid(base))</span>
<span class="cstat-no" title="statement not covered" >                        return INVALID;</span>
<span class="cstat-no" title="statement not covered" >                    return Promise.resolve(effect.transform(base.value, checkCtx)).then((result) =&gt; ({</span>
<span class="cstat-no" title="statement not covered" >                        status: status.value,</span>
...
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        util.assertNever(effect);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
ZodEffects.create = <span class="fstat-no" title="function not covered" >(schema, effect, params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodEffects({</span>
<span class="cstat-no" title="statement not covered" >        schema,</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodEffects,</span>
<span class="cstat-no" title="statement not covered" >        effect,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
ZodEffects.createWithPreprocess = <span class="fstat-no" title="function not covered" >(preprocess, schema, params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodEffects({</span>
<span class="cstat-no" title="statement not covered" >        schema,</span>
<span class="cstat-no" title="statement not covered" >        effect: { type: "preprocess", transform: preprocess },</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodEffects,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
...
<span class="fstat-no" title="function not covered" >    unwrap() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.innerType;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
...
<span class="cstat-no" title="statement not covered" >        const parsedType = this._getType(input);</span>
<span class="cstat-no" title="statement not covered" >        if (parsedType === ZodParsedType.null) {</span>
<span class="cstat-no" title="statement not covered" >            return OK(null);</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return this._def.innerType._parse(input);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    unwrap() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.innerType;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
ZodNullable.create = <span class="fstat-no" title="function not covered" >(type, params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodNullable({</span>
<span class="cstat-no" title="statement not covered" >        innerType: type,</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodNullable,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
export class ZodDefault extends ZodType {
    _parse(input) {
        ...
        let data = ctx.data;
        if (ctx.parsedType === ZodParsedType.undefined) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            data = this._def.defaultValue();</span>
<span class="cstat-no" title="statement not covered" >        }</span>
...
<span class="fstat-no" title="function not covered" >    removeDefault() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.innerType;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
ZodDefault.create = <span class="fstat-no" title="function not covered" >(type, params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodDefault({</span>
<span class="cstat-no" title="statement not covered" >        innerType: type,</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodDefault,</span>
<span class="cstat-no" title="statement not covered" >        defaultValue: typeof params.default === "function" ? params.default : () =&gt; params.default,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
...
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        const { ctx } = this._processInputParams(input);</span>
<span class="cstat-no" title="statement not covered" >        // newCtx is used to not collect issues from inner types in ctx</span>
<span class="cstat-no" title="statement not covered" >        const newCtx = {</span>
<span class="cstat-no" title="statement not covered" >            ...ctx,</span>
<span class="cstat-no" title="statement not covered" >            common: {</span>
<span class="cstat-no" title="statement not covered" >                ...ctx.common,</span>
<span class="cstat-no" title="statement not covered" >                issues: [],</span>
<span class="cstat-no" title="statement not covered" >            },</span>
<span class="cstat-no" title="statement not covered" >        };</span>
<span class="cstat-no" title="statement not covered" >        const result = this._def.innerType._parse({</span>
<span class="cstat-no" title="statement not covered" >            data: newCtx.data,</span>
<span class="cstat-no" title="statement not covered" >            path: newCtx.path,</span>
<span class="cstat-no" title="statement not covered" >            parent: {</span>
<span class="cstat-no" title="statement not covered" >                ...newCtx,</span>
<span class="cstat-no" title="statement not covered" >            },</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >        if (isAsync(result)) {</span>
<span class="cstat-no" title="statement not covered" >            return result.then((result) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                return {</span>
<span class="cstat-no" title="statement not covered" >                    status: "valid",</span>
<span class="cstat-no" title="statement not covered" >                    value: result.status === "valid"</span>
<span class="cstat-no" title="statement not covered" >                        ? result.value</span>
<span class="cstat-no" title="statement not covered" >                        : this._def.catchValue({</span>
<span class="cstat-no" title="statement not covered" >                            get error() {</span>
<span class="cstat-no" title="statement not covered" >                                return new ZodError(newCtx.common.issues);</span>
<span class="cstat-no" title="statement not covered" >                            },</span>
<span class="cstat-no" title="statement not covered" >                            input: newCtx.data,</span>
<span class="cstat-no" title="statement not covered" >                        }),</span>
<span class="cstat-no" title="statement not covered" >                };</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >        }</span>
...
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    removeCatch() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.innerType;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
ZodCatch.create = <span class="fstat-no" title="function not covered" >(type, params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodCatch({</span>
<span class="cstat-no" title="statement not covered" >        innerType: type,</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodCatch,</span>
<span class="cstat-no" title="statement not covered" >        catchValue: typeof params.catch === "function" ? params.catch : () =&gt; params.catch,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
...
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        const parsedType = this._getType(input);</span>
<span class="cstat-no" title="statement not covered" >        if (parsedType !== ZodParsedType.nan) {</span>
<span class="cstat-no" title="statement not covered" >            const ctx = this._getOrReturnCtx(input);</span>
<span class="cstat-no" title="statement not covered" >            addIssueToContext(ctx, {</span>
<span class="cstat-no" title="statement not covered" >                code: ZodIssueCode.invalid_type,</span>
<span class="cstat-no" title="statement not covered" >                expected: ZodParsedType.nan,</span>
<span class="cstat-no" title="statement not covered" >                received: ctx.parsedType,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
<span class="cstat-no" title="statement not covered" >            return INVALID;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return { status: "valid", value: input.data };</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
ZodNaN.create = <span class="fstat-no" title="function not covered" >(params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodNaN({</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodNaN,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
...
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        const { ctx } = this._processInputParams(input);</span>
<span class="cstat-no" title="statement not covered" >        const data = ctx.data;</span>
<span class="cstat-no" title="statement not covered" >        return this._def.type._parse({</span>
<span class="cstat-no" title="statement not covered" >            data,</span>
<span class="cstat-no" title="statement not covered" >            path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >            parent: ctx,</span>
<span class="cstat-no" title="statement not covered" >        });</span>
...
<span class="cstat-no" title="statement not covered" >        const { status, ctx } = this._processInputParams(input);</span>
<span class="cstat-no" title="statement not covered" >        if (ctx.common.async) {</span>
<span class="cstat-no" title="statement not covered" >            const handleAsync = async () =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                const inResult = await this._def.in._parseAsync({</span>
<span class="cstat-no" title="statement not covered" >                    data: ctx.data,</span>
<span class="cstat-no" title="statement not covered" >                    path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                    parent: ctx,</span>
<span class="cstat-no" title="statement not covered" >                });</span>
<span class="cstat-no" title="statement not covered" >                if (inResult.status === "aborted")</span>
<span class="cstat-no" title="statement not covered" >                    return INVALID;</span>
<span class="cstat-no" title="statement not covered" >                if (inResult.status === "dirty") {</span>
<span class="cstat-no" title="statement not covered" >                    status.dirty();</span>
<span class="cstat-no" title="statement not covered" >                    return DIRTY(inResult.value);</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >                else {</span>
<span class="cstat-no" title="statement not covered" >                    return this._def.out._parseAsync({</span>
<span class="cstat-no" title="statement not covered" >                        data: inResult.value,</span>
<span class="cstat-no" title="statement not covered" >                        path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                        parent: ctx,</span>
<span class="cstat-no" title="statement not covered" >                    });</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >            };</span>
<span class="cstat-no" title="statement not covered" >            return handleAsync();</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        else {</span>
<span class="cstat-no" title="statement not covered" >            const inResult = this._def.in._parseSync({</span>
<span class="cstat-no" title="statement not covered" >                data: ctx.data,</span>
<span class="cstat-no" title="statement not covered" >                path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                parent: ctx,</span>
<span class="cstat-no" title="statement not covered" >            });</span>
...
<span class="cstat-no" title="statement not covered" >                return {</span>
<span class="cstat-no" title="statement not covered" >                    status: "dirty",</span>
<span class="cstat-no" title="statement not covered" >                    value: inResult.value,</span>
<span class="cstat-no" title="statement not covered" >                };</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            else {</span>
<span class="cstat-no" title="statement not covered" >                return this._def.out._parseSync({</span>
<span class="cstat-no" title="statement not covered" >                    data: inResult.value,</span>
<span class="cstat-no" title="statement not covered" >                    path: ctx.path,</span>
<span class="cstat-no" title="statement not covered" >                    parent: ctx,</span>
<span class="cstat-no" title="statement not covered" >                });</span>
...
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    static <span class="fstat-no" title="function not covered" >create(a, b) {</span>
<span class="cstat-no" title="statement not covered" >        return new ZodPipeline({</span>
<span class="cstat-no" title="statement not covered" >            in: a,</span>
<span class="cstat-no" title="statement not covered" >            out: b,</span>
<span class="cstat-no" title="statement not covered" >            typeName: ZodFirstPartyTypeKind.ZodPipeline,</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
export class ZodReadonly extends ZodType {
<span class="fstat-no" title="function not covered" >    _parse(input) {</span>
<span class="cstat-no" title="statement not covered" >        const result = this._def.innerType._parse(input);</span>
<span class="cstat-no" title="statement not covered" >        const freeze = (data) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            if (isValid(data)) {</span>
<span class="cstat-no" title="statement not covered" >                data.value = Object.freeze(data.value);</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            return data;</span>
<span class="cstat-no" title="statement not covered" >        };</span>
<span class="cstat-no" title="statement not covered" >        return isAsync(result) ? result.then((data) =&gt; freeze(data)) : freeze(result);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="fstat-no" title="function not covered" >    unwrap() {</span>
<span class="cstat-no" title="statement not covered" >        return this._def.innerType;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
}
ZodReadonly.create = <span class="fstat-no" title="function not covered" >(type, params) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return new ZodReadonly({</span>
<span class="cstat-no" title="statement not covered" >        innerType: type,</span>
<span class="cstat-no" title="statement not covered" >        typeName: ZodFirstPartyTypeKind.ZodReadonly,</span>
<span class="cstat-no" title="statement not covered" >        ...processCreateParams(params),</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >};</span>
////////////////////////////////////////
...
////////////////////////////////////////
////////////////////////////////////////
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function cleanParams(params, data) {</span></span>
<span class="cstat-no" title="statement not covered" >    const p = typeof params === "function" ? params(data) : typeof params === "string" ? { message: params } : params;</span>
<span class="cstat-no" title="statement not covered" >    const p2 = typeof p === "string" ? { message: p } : p;</span>
<span class="cstat-no" title="statement not covered" >    return p2;</span>
<span class="cstat-no" title="statement not covered" >}</span>
export <span class="fstat-no" title="function not covered" >function custom(check, _params = {}, </span>
<span class="cstat-no" title="statement not covered" >/**</span>
<span class="cstat-no" title="statement not covered" > * @deprecated</span>
<span class="cstat-no" title="statement not covered" > *</span>
<span class="cstat-no" title="statement not covered" > * Pass `fatal` into the params object instead:</span>
<span class="cstat-no" title="statement not covered" > *</span>
<span class="cstat-no" title="statement not covered" > * ```ts</span>
<span class="cstat-no" title="statement not covered" > * z.string().custom((val) =&gt; val.length &gt; 5, { fatal: false })</span>
<span class="cstat-no" title="statement not covered" > * ```</span>
<span class="cstat-no" title="statement not covered" > *</span>
<span class="cstat-no" title="statement not covered" > */</span>
<span class="cstat-no" title="statement not covered" >fatal) {</span>
<span class="cstat-no" title="statement not covered" >    if (check)</span>
<span class="cstat-no" title="statement not covered" >        return ZodAny.create().superRefine((data, ctx) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            const r = check(data);</span>
<span class="cstat-no" title="statement not covered" >            if (r instanceof Promise) {</span>
<span class="cstat-no" title="statement not covered" >                return r.then((r) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                    if (!r) {</span>
<span class="cstat-no" title="statement not covered" >                        const params = cleanParams(_params, data);</span>
<span class="cstat-no" title="statement not covered" >                        const _fatal = params.fatal ?? fatal ?? true;</span>
<span class="cstat-no" title="statement not covered" >                        ctx.addIssue({ code: "custom", ...params, fatal: _fatal });</span>
<span class="cstat-no" title="statement not covered" >                    }</span>
<span class="cstat-no" title="statement not covered" >                });</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            if (!r) {</span>
...
<span class="cstat-no" title="statement not covered" >            return;</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >    return ZodAny.create();</span>
<span class="cstat-no" title="statement not covered" >}</span>
...
const instanceOfType = <span class="fstat-no" title="function not covered" >(</span>
<span class="cstat-no" title="statement not covered" >// const instanceOfType = &lt;T extends new (...args: any[]) =&gt; any&gt;(</span>
<span class="cstat-no" title="statement not covered" >cls, params = {</span>
<span class="cstat-no" title="statement not covered" >    message: `Input not instance of ${cls.name}`,</span>
<span class="cstat-no" title="statement not covered" >}) =&gt; custom((data) =&gt; data instanceof cls, params);</span>
...
const ostring = <span class="fstat-no" title="function not covered" >() =&gt; stringType().optional();</span>
const onumber = <span class="fstat-no" title="function not covered" >() =&gt; numberType().optional();</span>
const oboolean = <span class="fstat-no" title="function not covered" >() =&gt; booleanType().optional();</span>
export const coerce = {
    string: (<span class="fstat-no" title="function not covered" >(arg) =&gt; ZodString.create({ ...arg, coerce: true })),</span>
    number: (<span class="fstat-no" title="function not covered" >(arg) =&gt; ZodNumber.create({ ...arg, coerce: true })),</span>
    boolean: (<span class="fstat-no" title="function not covered" >(arg) =&gt; ZodBoolean.create({</span>
<span class="cstat-no" title="statement not covered" >        ...arg,</span>
<span class="cstat-no" title="statement not covered" >        coerce: true,</span>
<span class="cstat-no" title="statement not covered" >    })),</span>
    bigint: (<span class="fstat-no" title="function not covered" >(arg) =&gt; ZodBigInt.create({ ...arg, coerce: true })),</span>
    date: (<span class="fstat-no" title="function not covered" >(arg) =&gt; ZodDate.create({ ...arg, coerce: true })),</span>
};
