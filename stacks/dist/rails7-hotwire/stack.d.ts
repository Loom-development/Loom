export declare const rails7HotwireStack: {
    readonly id: "rails7-hotwire";
    readonly definitionVersion: 2;
    readonly legacyScaffoldVersions: readonly ["2", "rails-7.1.5-hotwire"];
    readonly assetPath: "rails7-hotwire/templates";
    ...
    readonly generator: {
        ...
        readonly command: readonly ["sh", "-c", "gem install bundler -v 2.6.9 --no-document && gem install {package} -v {version} --no-document && /usr/local/bundle/bin/rails _{version}_ new . --skip-test --skip-system-test"];
        readonly execution: {
            readonly kind: "container";
            readonly context: "Rails 7 + Hotwire project with Podman";
    ...
    readonly start: readonly ["bin/rails server -b 0.0.0.0 -p 3008"];
    readonly readiness: {
        readonly kind: "port";
        readonly value: "127.0.0.1:3008";
        readonly timeoutSeconds: 610;
    };
    readonly hostWrites: readonly ["log", "tmp", "vendor/bundle"];
    readonly verification: readonly [{
        readonly service: "app";
        readonly command: readonly ["ruby", "-rsocket", "-e", "TCPSocket.new('127.0.0.1', 3008).close"];
    }];
