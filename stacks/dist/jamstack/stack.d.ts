export declare const jamstackStack: {
    readonly id: "jamstack";
    readonly definitionVersion: 2;
    readonly legacyScaffoldVersions: readonly ["1", "2"];
    readonly assetPath: "jamstack/templates";
    ...
    readonly start: readonly ["cd api && npm start", "cd web && npm run dev -- --host 0.0.0.0 --port 5174"];
    readonly readiness: {
        readonly kind: "http";
        readonly value: "http://127.0.0.1:5174";
        readonly timeoutSeconds: 325;
    };
    readonly hostWrites: readonly ["api/node_modules", "web/node_modules"];
    readonly verification: readonly [{
        readonly service: "web";
        readonly command: readonly ["node", "-e", "fetch('http://127.0.0.1:5174').then(r=>process.exit(r.ok?0:1)).catch(()=>process.exit(1))"];
    }];
