export declare const nodeMernStack: {
    readonly id: "node-mern";
    readonly definitionVersion: 2;
    readonly legacyScaffoldVersions: readonly ["1", "2"];
    readonly assetPath: "node-mern/templates";
    ...
    readonly readiness: {
        readonly kind: "http";
        readonly value: "http://127.0.0.1:5173";
        readonly timeoutSeconds: 325;
    };
    readonly hostWrites: readonly ["api/node_modules", "web/node_modules"];
    readonly verification: readonly [{
        readonly service: "web";
        readonly command: readonly ["node", "-e", "fetch('http://127.0.0.1:5173').then(r=>process.exit(r.ok?0:1)).catch(()=>process.exit(1))"];
    }];
