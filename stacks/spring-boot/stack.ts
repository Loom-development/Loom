...
export const springBootStack = defineStack({
  id: "spring-boot", definitionVersion: 2, legacyScaffoldVersions: ["1"], assetPath: "spring-boot/templates", scaffoldVersion: "2",
  ...
  verification: ["wget", "-q", "-O-", "http://127.0.0.1:8080/api/health"], loomOwnedFiles: [".env.example", "loom.yaml"],
